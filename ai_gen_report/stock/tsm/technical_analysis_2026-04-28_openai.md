...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $392.34 | 🟢 | 價格持續上升 |
| **均線** | MA20 | $368.51 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $357.85 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $301.80 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 62.50 | 🟡 | 偏多，中性偏上 |
| **動能** | MACD | 12.719 | 🟢 | 多頭趨勢 |
| **波動** | ATR | $12.89 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2026-04 | $392.34 | +16.13% | 持續上升 |
| 2026-03 | $337.95 | -9.54% | 調整 |
| 2026-02 | $373.53 | +13.31% | 強勁上升 |

### 📊 中期趨勢（週線分析）

中期走勢顯示，價格在主要支撐位上方運行，波動加劇，需注意量能變化。

### ⚡ 趨勢強度評估（ADX 解讀）

```mermaid
graph TD
    ADX_Weak["ADX < 25"] --> 盤整["弱趨勢"]
    +DI["+DI > -DI"] --> 多頭主導
```

目前 ADX(14) 為 21.83，顯示弱趨勢以盤整為主，但多頭仍主導。
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-04 | $392.34 | 長陽 | 進一步上升趨勢 | 🟢 |
| 2026-03 | $337.95 | 長陰 | 調整結束 | 🟡 |
...
形態目標價計算：頸線 $250，形態高度 $150，目標價 $400。
...
現價位於布林通道上軌下方，顯示潛在上升空間。

### 💹 成交量分析（量價配合度）

量能高於20日均量，顯示價格上升獲得量能支撐。
...
ATR 為 $12.89，建議止損距離為 $13-$15。

### 📐 Beta 與市場相關性

TSM 與大盤的相關性高，Beta 約為1.2，顯示高於市場波動。
...
| 長期 | 上升 | 強 | 多頭 | 完整 | 80/100 | 進場 |

### 🔲 綜合訊號矩陣

展示短期/中期/長期各維度訊號的一致性分析，顯示整體偏多。

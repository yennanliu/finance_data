...
graph TD
    ...
    subgraph 動能指標
        ...
        nb5["RSI -- 頂背離"] --> P
        nb6["MACD_LINE -- 跌破"] --> MACD_SIGNAL
        nb7["MACD_HIST -- 負值"] --> MACD_LINE
        nb8["MACD_HIST -- 頂背離"] --> P
    end
...
graph TD
    ...
    nb1["Current_Price -- 位於下方"] --> MA20_Val
    nb2["Current_Price -- 位於上方"] --> MA50_Val
    nb2["Current_Price -- 位於上方"] --> MA200_Val

    nb3["MA20_Val -- >"] --> nb4["MA50_Val -- >"] --> MA200_Val
...
graph TD
    ...
    nb1["MACD_Line -- 跌破"] --> M_Signal
    nb2["M_Hist -- 負值且擴大"] --> MACD_Line
...
graph TD
    ...
    nb1["P -- 價格回調"] --> V
    nb2["OBV_Signal -- 量價背離"] --> P
    nb3["Vol_Signal -- 下跌放量"] --> P
```

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $397.67 | 🟢 | 位於多頭區域 |
| **均線** | MA20 | $376.96 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $359.93 | 🟢 | 支撐上行 |
| **均線** | MA200 | $304.25 | 🟢 | 長期支撐上行 |
| **動能** | RSI(14) | 63.44 | 🟡 | 中性區間 |
| **動能** | MACD | 12.894 | 🟢 | 多頭 |
| **波動** | ATR | $13.40 | 🟡 | 中度波動 |
...
|--------|----------|----------|--------|------|
| 2025年5月-2026年5月 | $190.95 | $397.67 | 108.2% | 強勁上升 |
...
ADX 22.64 表示目前市場處於盤整階段，需等待突破信號。
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-04 | $396.06 | 長陽線 | 多頭進攻 | 🟢 |
| 2026-03 | $337.95 | 十字星 | 中性等待 | 🟡 |
...
上升三角形目標價：計算方法為突破點 $397.67 + 形態高度 $36 = $433.67
...
ATR $13.40 提示當前波動中度，建議止損距離 $20 以應對波動。

### 📐 Beta 與市場相關性

Beta 1.3，顯示 TSM 與大盤具高相關性，市場波動對其影響顯著。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 強 | 多頭 | 完整 | 85 | 持續看多 |
| 中期 | 上升 | 中性 | 多頭 | 完整 | 75 | 觀望 |
| 短期 | 盤整 | 中性 | 多頭 | 未確認 | 60 | 謹慎 |

### 🔲 綜合訊號矩陣

短期/中期/長期訊號大致一致，顯示偏多格局。

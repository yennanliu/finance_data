...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $379.89 | 🟢 | 高於主要均線 |
| **均線** | MA20 | $345.47 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $351.56 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $294.12 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 66.93 | 🟡 | 中性偏多 |
| **動能** | MACD | 6.441 | 🟢 | 多頭訊號 |
| **波動** | ATR | $13.07 | 🟡 | 中等波動 |
...
- ATR為$13.07，建議止損距離設於$13內
- 波動率中等，適合短線交易

### 📐 Beta 與市場相關性

- 與大盤相關性高，Beta值顯示高於市場平均
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 強 | 多頭排列 | 頭肩底 | 80/100 | 持有 |
| 中期 | 盤整 | 中 | 混合 | - | 60/100 | 觀望 |
| 短期 | 盤整 | 弱 | 混合 | - | 50/100 | 觀望 |

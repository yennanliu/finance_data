...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $393.83 | 🟢 | 價格接近52W高點 |
| **均線** | MA20 | $371.30 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $358.47 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $302.64 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 63.26 | 🟡 | 中性，靠近超買區 |
| **動能** | MACD | 12.775 | 🟢 | 多頭 |
| **波動** | ATR | $12.90 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 走勢特徵 |
|------|--------|--------|----------|
| 2026-04 | 393.83 | +16.6% | 強勢上揚 |
| 2026-03 | 337.95 | -9.5% | 小幅回調 |
| 2026-02 | 373.53 | +13.3% | 大幅上漲 |
| 2026-01 | 329.63 | +8.8% | 穩步上升 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-04 | 393.83 | 大陽線 | 強勢上漲 | 🟢 |
| 2026-03 | 337.95 | 穿頭破腳 | 可能反轉 | 🟡 |
...
目標價計算方法：突破頸線 $380 + 形態高度 $40 = 目標價 $420
...
```mermaid
graph TD
    A["MACD線 12.775"] --> B["Signal線 10.011"]
    C["Hist +2.764"] --> D["看多"]
```
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 多頭 | 強 | 多頭排列 | 頭肩底 | 85 | 繼續持有 |
| 中期 | 震盪 | 中等 | 多頭排列 | 突破 | 70 | 謹慎持有 |
| 短期 | 多頭 | 強 | 多頭排列 | - | 75 | 短線跟隨 |

### 🔲 綜合訊號矩陣

短期/中期/長期訊號一致性良好，顯示多頭趨勢。
...
最優策略組合：
1. 🥇 最佳機會：突破$400進場，目標$420
2. 🥈 次選機會：回調至$380進場，目標$400
3. 🥉 保守選擇：觀望等待更多確認信號
════════════════════════════════════════════════════════
```

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $198.48 | 🟡 | 位於中軌附近 |
| **均線** | MA20 | $198.27 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $187.33 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $183.97 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 51.99 | 🟡 | 中性 |
| **動能** | MACD | -0.689 | 🔴 | 空頭 |
| **波動** | ATR | $6.39 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2025-05 | $135.10 | - | 初步上升趨勢 |
| 2026-05 | $198.48 | +46.92% | 多頭趨勢 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-11 | $176.98 | 十字星 | 變盤信號 | 🟡 |
| 2026-01 | $191.12 | 大陽線 | 繼續上漲 | 🟢 |
...
最優策略組合：
1. 🥇 最佳機會：突破$200後進場，目標$220
2. 🥈 次選機會：回調$190支撐進場，目標$210
3. 🥉 保守選擇：觀望等待趨勢明朗
════════════════════════════════════════════════════════
```

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $208.27 | 🟢 | 高於所有均線 |
| **均線** | MA20 | $188.38 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $185.02 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $182.83 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 86.68 | 🔴 | 超買 |
| **動能** | MACD | 6.508 | 🟢 | 多頭 |
| **波動** | ATR | $5.28 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2025-04 | 108.89 | -0.5% | 低位震盪 |
| 2025-05 | 135.10 | +24.1% | 強勢反彈 |
| 2025-06 | 157.96 | +16.9% | 持續上漲 |
| 2025-07 | 177.84 | +12.6% | 進一步突破 |
| 2025-08 | 174.15 | -2.1% | 小幅回調 |
| 2025-09 | 186.56 | +7.1% | 再次上攻 |
| 2025-10 | 202.47 | +8.5% | 新高 |
| 2025-11 | 176.98 | -12.6% | 調整 |
| 2025-12 | 186.49 | +5.3% | 反彈 |
| 2026-01 | 191.12 | +2.5% | 小幅上升 |
| 2026-02 | 177.18 | -7.3% | 調整 |
| 2026-03 | 174.40 | -1.6% | 低位震盪 |
| 2026-04 | 208.27 | +19.4% | 強勢突破 |

### 📊 中期趨勢（週線分析）

繪製近期壓力與支撐示意圖，顯示在 $192 和 $212 之間的主要波動區間。

### ⚡ 趨勢強度評估（ADX 解讀）

```mermaid
graph TD
    ADX["ADX(14): 23.61"] -->|弱趨勢| 弱勢
    +DI["+DI: 34.52"] -->|多頭主導| 強勢
    -DI["-DI: 16.00"] -->|空頭壓制| 弱勢
    弱勢 -->|綜合| 結論{"趨勢強度\\n弱"}
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | 191.12 | 錘子線 | 反轉信號 | 🟢 |
| 2026-03 | 174.40 | 十字星 | 不確定性 | 🟡 |
| 2026-04 | 208.27 | 大陽線 | 強勢 | 🟢 |
...
- **三角形目標價**：突破後目標價計算為 $230（突破點 $212 + 形態高度 $18）
...
```mermaid
graph TD
    RSI["RSI: 86.68"] -->|超買| 指標1
    MACD["MACD: 6.508"] -->|看多| 指標2
    OBV["OBV趨勢: 看多"] -->|量能支持| 指標3
    指標1 -->|綜合| 結論{"指標分析\\n看多"}
    指標2 -->|綜合| 結論
    指標3 -->|綜合| 結論
```
...
近期成交量高於20日均量，量能配合上漲趨勢，OBV顯示量能支持行情。
...
Beta 值顯示 NVDA 與大盤具高度相關性，波動性略高於市場平均。
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 上漲 | 強 | 多頭 | 無 | 85/100 | 進場 |
| 中期 | 上漲 | 強 | 多頭 | 三角形 | 80/100 | 觀望 |
| 長期 | 上漲 | 強 | 多頭 | 頭肩頂 | 75/100 | 進場 |

### 🔲 綜合訊號矩陣

展示短期/中期/長期各維度訊號的一致性分析，強調一致性高的情況。
...
最優策略組合：
1. 🥇 最佳機會：價格突破 $212 進場，目標價 $230
2. 🥈 次選機會：價格回調至 $200 後進場，目標價 $220
3. 🥉 保守選擇：關注 RSI 回調至 70 附近再進場
════════════════════════════════════════════════════════
```

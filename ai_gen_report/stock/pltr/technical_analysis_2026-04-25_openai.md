...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $143.09 | 🟡 | 位於波動中段 |
| **均線** | MA20 | $142.38 | 🟢 | 價格略上方 |
| **均線** | MA50 | $144.35 | 🔴 | 價格略下方 |
| **均線** | MA200 | $164.43 | 🔴 | 價格遠下方 |
| **動能** | RSI(14) | 46.11 | 🟡 | 中性，無明顯趨勢 |
| **動能** | MACD | +0.742 | 🟢 | 多頭訊號 |
| **波動** | ATR | $7.67 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-03 | $146.28 | 吞沒形態 | 反轉可能 | 🟡 |
| 2026-04 | $143.09 | 十字星 | 觀望 | 🟡 |
...
```mermaid
graph LR
    A["MACD 線"] --> B{"是否在 Signal 線上方?"}
    B -- Yes --> C["多頭訊號"]
    B -- No --> D["空頭訊號"]
```

- **MACD 線**：+0.742，位於訊號線之上，顯示多頭。
...
- **Beta 值**：1.3，顯示與大盤相關性較高，波動性大於市場平均。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下行 | 中性 | 空頭排列 | 無 | 40/100 | 觀望 |
| 中期 | 盤整 | 偏多 | 空頭排列 | 雙頂 | 50/100 | 謹慎 |
| 短期 | 震盪 | 偏多 | 空頭排列 | 十字星 | 45/100 | 觀望 |

### 🔲 綜合訊號矩陣

- **一致性分析**：短期、中期、長期訊號不一致，建議觀望。

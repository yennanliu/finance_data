...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $146.03 | 🟡 | 位於 MA20 上方，MA200 下方 |
| **均線** | MA20 | $141.47 | 🟢 | 價格在 MA20 上方 |
| **均線** | MA50 | $145.40 | 🟢 | 價格在 MA50 上方 |
| **均線** | MA200 | $164.26 | 🔴 | 價格在 MA200 下方 |
| **動能** | RSI(14) | 61.82 | 🟡 | 中性，未超買超賣 |
| **動能** | MACD | -0.759 | 🟢 | 看多，柱狀圖轉正 |
| **波動** | ATR | $5.90 | 🟡 | 中等波動 |

### 🏆 技術評分卡

```
技術評分卡 — PLTR (2026-05-04)
════════════════════════════════════════════════════
趨勢強度      █████░░░░░░░░░░░░░░░  30/100  🔴
動能指標      ███████░░░░░░░░░░░░░  50/100  🟡
支撐穩定度    ████████░░░░░░░░░░░░  60/100  🟡
...
| 月份 | 收盤價 | 變動幅度 | 特徵描述 |
|------|--------|----------|----------|
| 2025-05 | 131.78 | +11.23% | 強勁上升 |
| 2025-06 | 136.32 | +3.45% | 持續上升 |
| 2025-07 | 158.35 | +16.18% | 大幅上漲 |
| 2025-08 | 156.71 | -1.03% | 小幅下跌 |
| 2025-09 | 182.42 | +16.39% | 帶量突破 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-04 | 139.11 | 十字星 | 轉折可能 | 🟡 |
| 2026-05 | 146.03 | 陽線 | 看多 | 🟢 |
...
graph TD
    A["短期 MA20"] -->|"價格上方"| B["短多"]
    C["長期 MA200"] -->|"價格下方"| D["長空"]
```

### 📉 RSI(14) 分析

- RSI 數值：61.82 🟡
- 超買超賣區間分析：位於中性30-70區間
- 背離判斷：⚠️ 底背離，具備看漲潛力
...
- ATR值：$5.90，建議止損距離設定在 $6-$8 範圍內

### 📐 Beta 與市場相關性

- Beta：1.25，與市場相關性高，市場波動將顯著影響PLTR價格
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下降 | 弱 | 空頭 | 頭肩底 | 40 | 觀望 |
| 中期 | 盤整 | 中 | 混合 | 無明確形態 | 50 | 觀望 |
| 短期 | 上升 | 強 | 多頭 | 頭肩底 | 60 | 考慮進場 |
...
- **止損嚴格執行**：設定合理止損點，避免重大損失
- **倉位管理**：控制單筆交易倉位，減少風險暴露
- **監控市場變化**：密切關注市場新聞及大盤動向

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $137.80 | 🟡 | 位於中間價位區域 |
| **均線** | MA20 | $141.23 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $145.70 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $163.93 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 41.70 | 🟡 | 中性，未超買或超賣 |
| **動能** | MACD | -1.978 | 🔴 | 空頭動能增強 |
| **波動** | ATR | $6.30 | 🔴 | 波動性中等偏高 |

### 🏆 技術評分卡

```
技術評分卡 — PLTR (2026-05-08)
════════════════════════════════════════════════════
趨勢強度      █████░░░░░░░░░░░░░░  35/100  🔴
動能指標      ███████░░░░░░░░░░░░  45/100  🟡
支撐穩定度    █████████░░░░░░░░░░  60/100  🟡
...
```mermaid
graph TD
    RSI["RSI Neutral"] -->|41.70| MACD["MACD Bearish"]
    MACD --> MA["MA Bearish"]
    MA --> ATR["ATR Moderate"]
```
...
```mermaid
graph TD
    M["MACD Line"] -->|低於| S["Signal Line"]
    S --> H["Histogram Negative"]
```
...
- PLTR 與大盤的Beta值顯示出高波動性，與市場相關性較高
...
|--------|----------|------|----------|------|----------|------|
| 日線   | 盤整    | 中性 | 空頭    | 頭肩頂 | 48/100  | 觀望 |
| 週線   | 盤整    | 弱   | 空頭    | 雙頂  | 50/100  | 觀望 |
| 月線   | 下行    | 弱   | 空頭    | 頭肩頂 | 45/100  | 謹慎 |

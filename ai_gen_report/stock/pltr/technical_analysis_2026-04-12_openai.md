...
> **報告日期**：2026-04-12 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$128.06
...
```mermaid
graph TD
    A[頭肩頂形成中] -- 頸線: $150 --> B[目標價: $100]
    C[雙底] -- 頸線: $180 --> D[目標價: $220]
```
...
| 2026-02 | $135.90 | 陽包陰 | 反彈可能 | 🟢 |
| 2026-04 | $128.06 | 長下影線 | 支撐顯現 | 🟡 |
...
- 頭肩頂目標價: 頸線 $150 - 形態高度 $50 = $100
- 雙底目標價: 頸線 $180 + 形態高度 $40 = $220
...
- 近期成交量增量明顯，可能反映價格波動即將加劇
- OBV 顯示量能配合不足，價格上行壓力大
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 空頭 | 弱 | 混合 | 頭肩頂 | 30/100 | 觀望 |
| 中期 | 盤整 | 弱 | 混合 | 頭肩頂 | 40/100 | 觀望 |
| 短期 | 盤整 | 弱 | 混合 | 頭肩頂 | 50/100 | 觀望 |
...
```mermaid
graph TD
    A[樂觀情境] --> B[價格突破 $150，趨勢反轉]
    C[基本情境] --> D[盤整持續，價格波動]
    E[悲觀情境] --> F[價格跌破 $110，空頭延續]
```
...
最優策略組合：
1. 🥇 最佳機會：等待價格突破 $150 進行多頭操作
2. 🥈 次選機會：若價格穩定在 $110 以上，考慮分批建倉
3. 🥉 保守選擇：保持觀望，等待市場趨勢明朗化
════════════════════════════════════════════════════════
```

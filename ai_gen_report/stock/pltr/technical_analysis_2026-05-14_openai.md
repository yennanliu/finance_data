...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $133.73 | 🔴 | 價格低於所有均線 |
| **均線** | MA20 | $140.41 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $144.78 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $163.48 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 38.55 | 🟡 | 中性偏弱 |
| **動能** | MACD | -2.788 | 🔴 | 空頭動能 |
| **波動** | ATR | $5.77 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-03 | $146.28 | 陰線 | 壓力重重 | 🔴 |
| 2026-04 | $139.11 | 小陽線 | 反彈可能 | 🟡 |
...
|--------|----------|------|----------|------|----------|------|
| 短期   | 反彈 | 中性 | 弱 | 頭肩頂 | 40/100 | 謹慎觀望 |
| 中期   | 盤整 | 弱 | 空頭 | 三角形態 | 35/100 | 觀望 |
| 長期   | 下跌 | 弱 | 空頭 | 頭肩頂 | 30/100 | 看空 |

### 🔲 綜合訊號矩陣

綜合分析短期、中期、長期訊號一致性，顯示空頭壓力較大。
...
最優策略組合：
1. 🥇 最佳機會：空頭策略 A，進場點 $130
2. 🥈 次選機會：空頭策略 B，進場點 $120
3. 🥉 保守選擇：觀望，等待突破關鍵價位
════════════════════════════════════════════════════════
```

...
graph TD;
  SOFI --> Lending;
  SOFI --> nb1["Technology Platform"];
  SOFI --> nb2["Financial Services"];
  Lending --> nb3["Personal Loans"];
  Lending --> nb4["Student Loans"];
  Lending --> nb5["Home Loans"];
  nb1["Technology Platform"] --> Galileo;
  nb2["Financial Services"] --> Invest;
  nb2["Financial Services"] --> Save;
```

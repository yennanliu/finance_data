...
```mermaid
graph TD
    TICKER["🎯 SOFI 綜合評分<br/>總分：8.4/10"]

    F["📊 基本面<br/>8/10<br/>財務數據強勁"]
    G["🚀 成長性<br/>9/10<br/>收入增長高"]
    P["💰 獲利能力<br/>8/10<br/>毛利率穩定"]
    B["🏦 財務健康<br/>7/10<br/>高資產負債率"]
    V["📈 估值<br/>9/10<br/>估值有吸引力"]
    ...
    F --> F1["✅ 42.5% YoY 收入增長<br/>✅ 101.2% YoY 淨利增長"]
    G --> G1["✅ 壟斷優勢功能"]
```
...
```mermaid
graph TD
    Company["SOFI Technologies, Inc.<br>市值：$20.52B<br>年營收：$3.91B"]
    
    Lending["借貸業務<br>佔比：60%"]
    Tech["技術平台<br>佔比：25%"]
    FinServ["金融服務<br>佔比：15%"]
    ...
    Tech --> Galileo["Galileo Platform"]
    FinServ --> Invest["投資管理"]
    FinServ --> ProtectMoney["資金保護"]
```

### 2.2 市場份額

```mermaid
pie title 公司與競爭對手市場份額（2026）
    "SOFI": 20
    "競爭對手 A": 40
    "競爭對手 B": 30
    "競爭對手 C": 10
...
graph TD
    ...
    CurrentAssets["流動資産 $20.4B"]
    NonCurrentAssets["非流動資産 $30.26B"]
    
    CashEquivalents["現金與等價物 $4.93B"]
    Receivables["應收賬款 $6.1B"]
    Inventory["庫存 $9.37B"]

    LongTermInvestments["長期投資 $4B"]
    PP&E["固定資産 $10.91B"]
    
    EBITDA["EBITDA 暫無明顯數據"]

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $17.91 | 🟡 | 位於52W區間34.6% |
| **均線** | MA20 | $16.44 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $18.17 | 🔴 | 價格在MA50下方 |
| **均線** | MA200 | $23.86 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 60.67 | 🟡 | 中性區間 |
| **動能** | MACD | -0.469 | 🟢 | 多頭信號 |
| **波動** | ATR | $0.82 | 🟡 | 中等波動 |
...
| 時期 | 起始價格 | 結束價格 | 漲跌幅 | 特徵 |
|------|----------|----------|--------|------|
| 2025-04 至 2025-10 | $12.51 | $29.68 | +137% | 強勢上漲 |
| 2025-10 至 2026-04 | $29.68 | $17.91 | -39.7% | 回調 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-11 | $29.72 | 陰線 | 回調訊號 | 🔴 |
| 2026-02 | $17.76 | 陽線 | 反彈訊號 | 🟢 |
...
- 頭肩頂：突破頸線後，預測目標價為 $15.00
- 雙頂：突破頸線後，預測目標價為 $20.00
...
```mermaid
graph TD
    短期["短期 MA20"] -->|"價格上方"| 看多["看多"]
    長期["長期 MA200"] -->|"價格下方"| 看空["看空"]
```
...
```mermaid
graph TD
    MACD線["MACD線: -0.469"] --> 訊號線["訊號線: -0.802"]
    訊號線 --> 柱狀圖["柱狀圖: +0.333"]
```
...
```mermaid
graph TD
    極樂觀["極樂觀情境"] --> 目標價["目標價 $30"]
    基本["基本情境"] --> 目標價["目標價 $24"]
    極悲觀["極悲觀情境"] --> 目標價["目標價 $15"]
```

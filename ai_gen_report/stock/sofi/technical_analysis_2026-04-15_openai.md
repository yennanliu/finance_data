...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $18.79 | 🟡 | 目前位於52周區間37.5% |
| **均線** | MA20 | $16.51 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $18.11 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $23.86 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 67.39 | 🟡 | 中性偏多 |
| **動能** | MACD | -0.261 | 🟢 | 多頭 |
| **波動** | ATR | $0.83 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | 22.81 | 錘子線 | 可能反轉 | 🟢 |
| 2026-04 | 18.79 | 上影線 | 反彈受阻 | 🔴 |
...
- ATR 為 $0.83，建議止損距離設置於 $1.50 以內。

### 📐 Beta 與市場相關性

- 與大盤相關性較低，Beta 指數顯示中等風險。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 中等 | 空頭 | 雙底 | 70/100 | 觀望 |
| 中期 | 調整 | 強 | 多頭 | 反彈 | 75/100 | 進場 |
| 短期 | 反彈 | 強 | 多頭 | 暫無 | 80/100 | 進場 |

### 🔲 綜合訊號矩陣

- 短期與中期訊號一致性較高，顯示潛在反彈機會。
...
最優策略組合：
1. 🥇 突破後多頭進場：突破 $20 進場，目標價 $25
2. 🥈 回踩後多頭進場：回踩 $18 進場，目標價 $22
3. 🥉 觀望等待：等待關鍵阻力或支撐突破
════════════════════════════════════════════════════════
```

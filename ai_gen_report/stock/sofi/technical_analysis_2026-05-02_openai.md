...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $16.43 | 🔴 | 價格低於主要均線 |
| **均線** | MA20 | $17.64 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $17.60 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $23.76 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 46.42 | 🟡 | 中性 |
| **動能** | MACD | -0.161 | 🔴 | 空頭 |
| **波動** | ATR | $0.99 | 🟡 | 中等波動 |
...
| 時間區間 | 起始價 | 結束價 | 漲跌幅 | 特徵 |
|----------|--------|--------|--------|------|
| 2025年5月-2025年10月 | $13.30 | $29.68 | +123% | 強勁上漲 |
| 2025年10月-2026年5月 | $29.68 | $16.43 | -44% | 回落修正 |
...
```mermaid
graph TD
    ADX["ADX = 26.24"] --> 強趨勢["強趨勢 > 25"]
    +DI["+DI = 24.12"] --> 空頭主導["-DI = 33.47"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026年1月 | $22.81 | 長上影線 | 看空壓力 | 🔴 |
| 2026年3月 | $15.88 | 錘子線 | 反彈可能 | 🟡 |
...
```mermaid
graph TD
    MACD線["MACD = -0.161"] --> 空頭趨勢
    訊號線["Signal = 0.053"] --> 空頭強化
    柱狀圖["Hist = -0.215"] --> 看空訊號
```
...
- 當前成交量：78,874,100 高於20日均量（64,825,465），量能支撐上漲趨勢。
...
- ATR：$0.99，建議止損距離設置為 $0.99 至 $1.98 之間。

### 📐 Beta 與市場相關性

- Beta：1.15，與大盤相關性較高，需注意市場波動對價格的影響。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 中性 | 中等 | 看空 | 形態待定 | 60 | 觀望 |
| 中期 | 看空 | 弱 | 看空 | 頭肩頂 | 45 | 考慮減倉 |
| 短期 | 看空 | 弱 | 看空 | 短期反彈 | 50 | 謹慎觀望 |

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $611.91 | 🔴 | 價格低於均線 |
| **均線** | MA20 | $645.34 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $630.85 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $677.83 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 45.18 | 🟡 | 中性 |
| **動能** | MACD | 11.32 | 🔴 | 空頭趨勢 |
| **波動** | ATR | $19.73 | 🟡 | 中等波動 |
...
| 時段 | 起始價 | 終止價 | 漲跌幅 |
|------|--------|--------|--------|
| M1-M6 | $463.69 | $736.97 | +58.98% |
| M7-M12 | $736.97 | $611.91 | -17.00% |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-11 | $646.87 | 陰線 | 賣壓強 | 🔴 |
| 2026-01 | $715.89 | 陽線 | 反彈 | 🟢 |
...
- **ATR**：$19.73
- **止損建議**：以ATR的1.5倍作為止損，即約$29.60

### 📐 Beta 與市場相關性

- **Beta**：1.2（假設值）
- **解讀**：META 與大盤相關性較高，波動性大於市場平均
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下行 | 弱 | 看空 | 頭肩頂 | 3/10 | 觀望 |
| 中期 | 盤整 | 中性 | 看空 | 雙頂 | 4/10 | 觀望 |
| 短期 | 下行 | 弱 | 看空 | 無 | 2/10 | 觀望或做空 |
...
- **市場波動風險**：建議設置嚴格止損，控制單筆交易風險不超過資金的 2%
- **流動性風險**：確保交易量充足，以避免因流動性不足造成的滑點
- **倉位管理**：避免過度集中，建議分散配置於不同標的

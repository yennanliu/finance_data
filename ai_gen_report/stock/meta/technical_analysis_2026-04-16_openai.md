...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $671.58 | 🟡 | 介於中期均線之間 |
| **均線** | MA20 | $596.54 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $629.44 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $680.70 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 66.86 | 🟡 | 接近超買但仍中性 |
| **動能** | MACD | 5.851 | 🟢 | 多頭 |
| **波動** | ATR | $24.55 | 🟡 | 中等波動 |
...
```mermaid
graph TD
    MACD_line["MACD 線"] -->|"5.851"| 看多
    Signal_line["訊號線"] -->|"-7.379"| 看空
    Hist["柱狀圖"] -->|"+13.230"| 看多
```
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 強 | 看多 | 頭肩頂 | 75 | 繼續觀望 |
| 中期 | 上升 | 中等 | 看多 | 無 | 70 | 逢低買入 |
| 短期 | 盤整 | 弱 | 空頭 | 無 | 60 | 短線交易 |

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $608.74 | 🔴 | 價格低於主要均線 |
| **均線** | MA20 | $647.06 | 🔴 | 價格在MA20下方 |
| **均線** | MA50 | $630.14 | 🔴 | 價格在MA50下方 |
| **均線** | MA200 | $677.37 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 43.01 | 🟡 | 中性偏弱 |
| **動能** | MACD | -5.340 | 🔴 | 空頭動能 |
| **波動** | ATR | $19.88 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 走勢特徵 |
|------|--------|--------|----------|
| 2025-05 | 645.48 | -5.8% | 震盪下行 |
| 2025-06 | 736.36 | +14.1% | 強勢反彈 |
| 2025-07 | 771.63 | +4.8% | 持續上行 |
| 2025-08 | 736.97 | -4.5% | 高位整理 |
| 2025-09 | 733.15 | -0.5% | 橫盤整理 |
| 2025-10 | 647.27 | -11.7% | 跌破支撐 |
| 2025-11 | 646.87 | -0.1% | 低位震盪 |
| 2025-12 | 659.53 | +2.0% | 小幅回升 |
| 2026-01 | 715.89 | +8.5% | 反彈強勢 |
| 2026-02 | 647.63 | -9.5% | 跳水下行 |
| 2026-03 | 572.13 | -11.7% | 持續下跌 |
| 2026-04 | 611.91 | +6.9% | 反彈走勢 |
...
```mermaid
graph TD
    HEAD["頭肩頂形態"] --> ID1["確認頸線突破"]
    DOUBLE_BOTTOM["雙底形態"] --> ID2["反彈未突破頸線"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-12 | 659.53 | 錘子線 | 底部反轉形態 | 🟢 |
| 2026-01 | 715.89 | 長紅棒 | 強勢反彈 | 🟢 |
| 2026-02 | 647.63 | 十字星 | 轉向不明 | 🟡 |
| 2026-03 | 572.13 | 黑烏鴉 | 看空 | 🔴 |

### 📉 ASCII 走勢形態示意圖

```
頭肩頂形態（區間：2025-08 至 2026-03）
價格軸 ($)
$750 ┤        ●
$700 ┤    ●      ●
$650 ┤●━━━━━━━━━●←頸線
...
- **最新成交量**：21,105,378
- **20日均量**：16,161,674
- **量價配合**：目前成交量高於均量，價格反彈配合成交量上升，顯示一定的多頭動能。
...
- **ATR**：$19.88
- **建議止損距離**：建議止損設置為 ATR 的 1.5 倍，即約 $30。

### 📐 Beta 與市場相關性

- Beta 值未提供，但可假設 META 與大盤有較高相關性，通常 META 作為大型科技股，偏向高 Beta。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下行 | 弱 | 看空 | 完整 | 40/100 | 觀察 |
| 中期 | 盤整 | 中 | 中性 | 不完整 | 50/100 | 持觀望 |
| 短期 | 上行 | 強 | 看多 | 初步形成 | 60/100 | 考慮進場 |
...
- **倉位管理**：建議倉位控制在總資金的 10%-20%，以防範價格劇烈波動。
- **止損設置**：嚴格遵守止損點，避免因情緒影響錯失賣出時機。
- **市場監控**：密切關注市場宏觀因素變化，尤其是美國科技股的整體走勢。
...
最優策略組合：
1. 🥇 最佳機會：短期反彈進場，目標價 $650
2. 🥈 次選機會：觀察 MACD 死叉，做空 $600
3. 🥉 保守選擇：持續觀望，等待趨勢明確
════════════════════════════════════════════════════════
```

...
```mermaid
graph TD
    META_SCORE["🎯 META 綜合評分<br/>總分：8.1/10"]

    FUNDAMENTALS["📊 基本面<br/>8/10<br/>強勁用戶基礎與技術領先"]
    GROWTH["🚀 成長性<br/>9/10<br/>大力推動VR/AR領域進取"]
    PROFITABILITY["💰 獲利能力<br/>8/10<br/>強大贏利能力與卓越現金流"]
    HEALTH["🏦 財務健康<br/>7/10<br/>靈活的財務狀況"]
    VALUATION["📈 估值<br/>8/10<br/>合宜的市場估值"]

    META_SCORE --> FUNDAMENTALS
    META_SCORE --> GROWTH
    META_SCORE --> PROFITABILITY
    META_SCORE --> HEALTH
    META_SCORE --> VALUATION

    FUNDAMENTALS --> F_D1["✅ 用戶基數龐大<br/>✅ 平台優良"]
    ...
```

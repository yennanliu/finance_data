...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $669.12 | 🟡 | 價格在52周區間中段 |
| **均線** | MA20 | $643.71 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $631.46 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $678.32 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 65.63 | 🟢 | 中性偏多 |
| **動能** | MACD | 16.597 | 🟢 | 多頭趨勢 |
| **波動** | ATR | $15.81 | 🟢 | 中等波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2025-05 | 645.48 | - | 上升趨勢開始 |
| 2025-06 | 736.36 | +14.1% | 強勁上升 |
| ... | ... | ... | ... |
| 2026-04 | 669.12 | -9.6% | 調整後反彈 |

### 📊 中期趨勢（週線分析）

使用圖表展示近期壓力與支撐示意圖。週線顯示價格在$650至$700區間震盪。

### ⚡ 趨勢強度評估（ADX 解讀）

```mermaid
graph TD
    A["ADX(14) = 23.03"] --> B["弱趨勢/盤整"]
    B --> C["+DI(32.42) > -DI(22.98)"]
    C --> D["多頭主導"]
```
...
成交量近期高於20日均量，量能支撐上漲趨勢，OBV指標顯示強勁。
...
最優策略組合：
1. 🥇 最佳機會：中期多頭策略，進場點$655，目標價$750
2. 🥈 次選機會：短期反彈策略，進場點$705，目標價$750
3. 🥉 保守選擇：觀望，等待突破確認
════════════════════════════════════════════════════════
```

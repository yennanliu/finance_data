...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $608.75 | 🔴 | 價格低於所有均線 |
| **均線** | MA20 | $647.06 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $630.14 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $677.37 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 43.01 | 🟡 | 接近中性 |
| **動能** | MACD | -5.340 | 🔴 | 空頭動能 |
| **波動** | ATR | $19.89 | 🟡 | 中等波動 |
...
| 階段 | 涨跌幅 | 特徵 |
|------|--------|------|
| 2025-05 to 2025-07 | +19.58% | 強勁上升趨勢 |
| 2025-09 to 2026-03 | -20.98% | 持續下降趨勢 |
...
```mermaid
graph TD
    MA分析["均線分析"] --> MA結果["均線空頭排列"]
    RSI分析["RSI分析"] --> RSI結果["中性偏弱"]
    MACD分析["MACD分析"] --> MACD結果["空頭動能"]
```
...
成交量處於高於均值狀態，但量能未能有效推動價格上升，顯示量價背離。
...
|--------|----------|------|----------|------|----------|------|
| 月線 | 空頭 | 弱 | 空頭 | 無明顯形態 | 30/100 | 觀望 |
| 週線 | 空頭 | 弱 | 空頭 | 雙底 | 45/100 | 觀望 |
| 日線 | 空頭 | 弱 | 空頭 | 無明顯形態 | 35/100 | 觀望 |

### 🔲 綜合訊號矩陣

綜合短期、中期與長期的技術訊號，顯示目前市場偏空，建議保守觀望。

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $355.26 | 🟢 | 高於均線 |
| **均線** | MA20 | $297.65 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $241.38 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $213.28 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 75.40 | 🔴 | 超買 |
| **動能** | MACD | 34.346 | 🟢 | 多頭 |
| **波動** | ATR | $19.74 | 🟡 | 中等波動 |
...
|------|--------|-----------|-----|
| 2025-05 | 110.73 | - | 低點形成 |
| 2025-10 | 256.12 | +131.2 | 強勁上升 |
| 2026-04 | 354.49 | +38.4 | 加速上升 |
...
```mermaid
graph TD
    ADX["ADX(14): 48.22"] -->|強趨勢| 趨勢強度["多頭主導"]
    +DI["+DI: 42.53"] -->|大於|-DI["-DI: 14.32"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-03 | 203.43 | 長紅 | 多頭 | 🟢 |
| 2026-04 | 354.49 | 長上影 | 警示 | 🟡 |
...
```mermaid
graph TD
    價格指標["價格 > MA20 > MA50 > MA200"] -->|多頭| 均線狀態["多頭排列"]
    RSI["RSI(14): 75.40"] -->|超買| RSI狀態["風險增加"]
    MACD["MACD: 34.346"] -->|多頭| MACD狀態["看多"]
```
...
```mermaid
graph TD
    短期["MA20: $297.65"] -->|價格上方| 看多
    中期["MA50: $241.38"] -->|價格上方| 看多
    長期["MA200: $213.28"] -->|價格上方| 看多
```
...
```mermaid
graph TD
    MACD線["MACD: 34.346"] -->|大於| 信號線["Signal: 30.219"]
    柱狀圖["Hist: +4.128"] -->|多頭| MACD看多
```
...
| 中期 | 上升 | 中等 | 多頭 | 完整 | 75/100 | 觀望 |
| 短期 | 上升 | 強 | 多頭 | 完整 | 80/100 | 買入 |

### 🔲 綜合訊號矩陣

短期/中期/長期各維度訊號一致性強，建議偏多操作。

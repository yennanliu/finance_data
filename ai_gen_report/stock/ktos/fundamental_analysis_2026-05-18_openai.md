...
graph TD
    ...
    F["📊 基本面<br/>8/10<br/>Defensive sector stability"]
    G["🚀 成長性<br/>9/10<br/>Rapid govt. segment expansion"]
    P["💰 獲利能力<br/>7/10<br/>Profits low, margins narrowing"]
    B["🏦 財務健康<br/>9/10<br/>Strong balance sheet"]
    V["📈 估值<br/>8/10<br/>High but justified by contracts"]
    ...
    F --> F1["✅ Revenue increase<br/> ✅ Strong R&D"]
    G --> G1["✅ Unmanned systems growth"]
    P --> P1["⚠️ High operational costs"]
    B --> B1["✅ Low debt ratio"]
    V --> V1["⚠️ Trailing P/E high"]
```

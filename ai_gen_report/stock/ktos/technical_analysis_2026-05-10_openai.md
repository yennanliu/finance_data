...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $57.89 | 🔴 | 位於多條均線下方 |
| **均線** | MA20 | $65.41 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $75.14 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $80.89 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 29.44 | 🟢 | 超賣 |
| **動能** | MACD | -4.780 | 🔴 | 死叉 |
| **波動** | ATR | $3.51 | 🟡 | 中等波動 |
...
| 階段 | 起始價格 | 結束價格 | 漲跌幅 | 特徵 |
|------|----------|----------|--------|------|
| 1 | $20.01 | $58.70 | +194% | 強勁上升 |
| 2 | $58.70 | $91.37 | +55% | 短暫震盪後突破 |
| 3 | $91.37 | $57.89 | -36% | 快速回調 |
...
```mermaid
graph TD
    ADX["ADX(14): 27.10"] -->|強趨勢| DIRECTION{"趨勢方向"}
    DIRECTION --> BULL["空頭主導"]
    DIRECTION --> BEAR["多頭主導"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-09 | $91.37 | 長上影線 | 拋壓沉重 | 🔴 |
| 2026-02 | $86.18 | 十字星 | 轉向不明 | 🟡 |
...
- 頸線：$58.00
- 頭頂高度：$91.37 - $58.00 = $33.37
- 目標價：$58.00 - $33.37 = $24.63
...
```mermaid
graph TD
    MACD_LINE["MACD 線: -4.780"] -->|低於| SIGNAL_LINE{"訊號線: -4.697"}
    SIGNAL_LINE --> HISTOGRAM{"柱狀圖: -0.083"}
```
...
- 最新成交量：4,310,600
- 20日均量：3,838,540 (量比: 1.12x)
- 成交量疲弱，OBV低於均線，確認下跌趨勢
...
| 中期 | 空頭 | 弱 | 空頭排列 | 雙頂 | 45 | 觀望 |
| 短期 | 空頭 | 弱 | 空頭排列 | 無 | 50 | 觀望 |
...
```mermaid
graph TD
    DECISION_POINT["策略選擇"] --> LONG["多頭策略"]
    DECISION_POINT --> SHORT["空頭策略"]
```

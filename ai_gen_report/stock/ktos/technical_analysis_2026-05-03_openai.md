...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $62.05 | 🔴 | 價格低於主要均線 |
| **均線** | MA20 | $68.49 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $78.42 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $80.85 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 26.64 | 🟢 | 超賣 |
| **動能** | MACD | -4.812 | 🔴 | 空頭 |
| **波動** | ATR | $3.70 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | $103.01 | 長上影線 | 空頭壓力 | 🔴 |
| 2026-03 | $70.51 | 長下影線 | 短期支撐 | 🟡 |
...
- ATR 為 $3.70，建議止損設於$3.70範圍內。

### 📐 Beta 與市場相關性

- 未提供 Beta 數據，需進一步確認市場相關性。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 空頭 | 弱 | 空頭 | 無 | 40/100 | 持續關注 |
| 中期 | 空頭 | 中 | 空頭 | 無 | 45/100 | 謹慎觀望 |
| 短期 | 超賣 | 弱 | 空頭 | 無 | 50/100 | 觀望 |
...
*報告生成時間：2026-05-03 ｜ 數據來源：提供數據 ｜ 分析框架：多時框技術分析*
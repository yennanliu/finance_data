...
> **報告日期**：2026-04-12 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$70.34
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-09 | 91.37 | 長上影線 | 多頭力竭 | 🔴 |
| 2026-01 | 103.01 | 高位十字星 | 反轉可能 | 🔴 |
...
```mermaid
graph TD
    MACD線["-5.471"] --> MACD信號線["-5.371"]
    MACD信號線 --> MACD柱狀圖["-0.100"]
```
...
- ATR 為 $5.56，建議止損距離設在 2ATR 以防止假突破

### 📐 Beta 與市場相關性

- 與大盤相關性中等，Beta 約為 1.2，波動較大盤略強
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 盤整 | 中性 | 空頭 | 頭肩頂 | 40/100 | 觀望 |
| 週線 | 盤整 | 中性 | 空頭 | 雙頂 | 45/100 | 觀望 |
| 月線 | 下跌 | 弱 | 空頭 | - | 35/100 | 觀望 |

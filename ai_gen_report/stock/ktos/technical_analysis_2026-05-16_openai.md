...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $52.09 | 🔴 | 價格位於多數均線下方 |
| **均線** | MA20 | $60.73 | 🔴 | 價格在MA20下方，空頭 |
| **均線** | MA50 | $71.81 | 🔴 | 價格在MA50下方，空頭 |
| **均線** | MA200 | $80.79 | 🔴 | 價格在MA200下方，空頭 |
| **動能** | RSI(14) | 31.33 | 🟡 | 接近超賣區域 |
| **動能** | MACD | -5.144 | 🔴 | 空頭訊號 |
| **波動** | ATR | $3.45 | 🔴 | 高波動風險 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2024-11 | 27.09 | 大陽線 | 強勁反彈 | 🟢 |
| 2025-09 | 91.37 | 錘子線 | 反轉可能 | 🟡 |
| 2026-01 | 103.01 | 吞噬線 | 短期見頂 | 🔴 |
...
```mermaid
graph TD
    MA20["MA20"] -->|價格下方| MA判斷{"空頭"}
    RSI["RSI"] -->|接近超賣| RSI判斷{"中性"}
    MACD["MACD"] -->|空頭交叉| MACD判斷{"空頭"}
    BB["布林通道"] -->|下緣| BB判斷{"空頭"}
    OBV["OBV"] -->|量能疲弱| OBV判斷{"空頭"}
```
...
```mermaid
graph TD
    MACD["MACD 線"] -->|低於訊號線| MACD判斷{"空頭"}
    Signal["訊號線"] -->|高於 MACD| MACD判斷
    Hist["柱狀圖"] -->|負值擴大| 看空信號
```
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 空頭 | 弱 | 空頭排列 | 頭肩頂 | 40 | 建議觀望 |
| 中期 | 空頭 | 弱 | 空頭排列 | 下降三角 | 45 | 建議觀望 |
| 短期 | 反彈 | 弱 | 空頭排列 | - | 50 | 短線操作 |
...
最優策略組合：
1. 🥇 短線反彈策略：在$52.50進場，目標價$60
2. 🥈 空頭策略：跌破$50進場，目標價$45
3. 🥉 觀望策略：等待信號確認後再行動
════════════════════════════════════════════════════════
```

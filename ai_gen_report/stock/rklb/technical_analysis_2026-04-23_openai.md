...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $84.60 | 🟢 | 價格上漲 |
| **均線** | MA20 | $72.72 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $71.38 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $60.97 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 70.63 | 🟡 | 超買 |
| **動能** | MACD | 4.734 | 🟢 | 多頭 |
| **波動** | ATR | $5.55 | 🟡 | 中等波動 |
...
| 時期 | 漲跌幅 | 特徵 |
|------|--------|------|
| 2025-06 - 2025-12 | +142% | 強勢上漲 |
| 2026-01 - 2026-04 | -20% | 回調修正 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-12 | $69.76 | 錘子線 | 反轉信號 | 🟢 |
| 2026-02 | $69.10 | 吞噬線 | 繼續下跌 | 🔴 |
...
```mermaid
graph TD
    A["MACD Line: 4.734"] --> B["高於 Signal Line: 2.569"]
    B --> C["看多"]
```
...
- 尚未提供具體 Beta 數值，建議與大盤進行比較以評估相關性。

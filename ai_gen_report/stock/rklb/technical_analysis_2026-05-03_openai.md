...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $78.81 | 🟡 | 目前處於中性區域 |
| **均線** | MA20 | $77.58 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $72.48 | 🟢 | 多頭排列 |
| **均線** | MA200 | $62.10 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 57.80 | 🟡 | 中性區域 |
| **動能** | MACD | -0.324 | 🔴 | 看空 |
| **波動** | ATR | $6.02 | 🟢 | 高波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2026-01 | 80.07 | +14.74% | 強勁上漲 |
| 2026-02 | 69.10 | -13.66% | 回調 |
| 2026-03 | 64.22 | -7.06% | 盤整 |
| 2026-04 | 82.51 | +28.51% | 強勁反彈 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | 80.07 | 吞噬形態 | 轉勢信號 | 🟢 |
| 2026-02 | 69.10 | 錘子線 | 反轉可能 | 🟢 |
...
- **雙頂形態**：頸線位於$70，形態高度$10，目標價=$60
- **上升三角形**：突破點位$80，目標價=$90
...
| MA排列 | 執行狀態 | 解讀 |
|--------|----------|------|
| MA20 > MA50 > MA200 | 正常 | 多頭排列，支撐上行趨勢 |

### 📉 RSI(14) 分析

- **RSI 數值進度條**：███████░░░░ 57.80 (中性)
- **超買超賣區間分析**：目前處於中性區域，無明顯超買或超賣
- **背離判斷**：無明顯背離
...
- 成交量略低於20日均量（0.73x），但OBV趨勢顯示量能支持價格上升
...
- **ATR**：$6.02，建議止損距離應設在5%-10%範圍內，約$72-$75

### 📐 Beta 與市場相關性

- **Beta**：假設數值為1.2，高於1，表示與市場有較強相關性，波動較高
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 強 | 多頭 | 完整 | 80 | 持有 |
| 中期 | 盤整 | 中性 | 多頭 | 部分完整 | 70 | 觀望 |
| 短期 | 下降 | 弱 | 多頭 | 不完整 | 60 | 謹慎 |
...
最優策略組合：
1. 🥇 最佳機會：等待突破$80進場，目標價$90
2. 🥈 次選機會：回調至$70後進場，目標價$85
3. 🥉 保守選擇：觀望，待市場明確方向後再行動
════════════════════════════════════════════════════════
```

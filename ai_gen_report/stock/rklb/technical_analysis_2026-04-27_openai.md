...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $82.29 | 🟢 | 高於均線 |
| **均線** | MA20 | $74.48 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $71.91 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $61.39 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 66.99 | 🟡 | 中性偏強 |
| **動能** | MACD | 4.192 | 🟢 | 多頭趨勢 |
| **波動** | ATR | $5.88 | 🟡 | 中等波動 |
...
| 時期 | 漲跌幅 | 特徵 |
|------|--------|------|
| 2025-04 至 2025-08 | +30% | 上升趨勢 |
| 2025-09 至 2025-12 | +50% | 快速上攻 |
| 2026-01 至 今 | -15% | 高位震盪 |
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 向下 | 中 | 多頭 | 修正 | 70/100 | 持有 |
| 中期 | 盤整 | 中 | 多頭 | 無明顯 | 75/100 | 觀望 |
| 長期 | 向上 | 強 | 多頭 | 上升 | 85/100 | 買入 |
...
最優策略組合：
1. 🥇 最佳機會：突破$85時進場，目標$90
2. 🥈 次選機會：回調至$75時進場，目標$80
3. 🥉 保守選擇：持有觀望，等待明確趨勢
════════════════════════════════════════════════════════
```

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $78.59 | 🟢 | 價格接近52週高點，顯示強勢 |
| **均線** | MA20 | $75.54 | 🟢 | 價格在MA20上方，短期多頭 |
| **均線** | MA50 | $72.13 | 🟢 | 價格在MA50上方，強勢延續 |
| **均線** | MA200 | $61.59 | 🟢 | 價格在MA200上方，長期多頭 |
| **動能** | RSI(14) | 59.92 | 🟡 | 中性區間，未超買 |
| **動能** | MACD | 3.732 | 🟢 | 多頭信號增強 |
| **波動** | ATR(14) | $5.69 | 🟡 | 波動中等，需注意風險 |

### 🏆 技術評分卡

```
技術評分卡 — RKLB (2026-04-28)
════════════════════════════════════════════════════
趨勢強度      ██████░░░░░░░░░░░░░░  60/100  🟡
動能指標      ████████░░░░░░░░░░░░  70/100  🟢
支撐穩定度    ███████████░░░░░░░░░  75/100  🟢
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-04 | $78.59 | 長陽線 | 確認突破 | 🟢 |
| 2026-03 | $64.22 | 長陰線 | 高位回落 | 🔴 |
...
```mermaid
graph TD
    MA系統["MA排列 多頭"] --> RSI["RSI 中性"]
    MACD["MACD 看多"] --> OBV["OBV 上升"]
    ADX["ADX 弱趨勢"] --> 結論["多頭優勢"]
```
...
```mermaid
graph TD
    短期MA["短期 MA20"] -->|價格上方| 看多["看多"]
    長期MA["長期 MA200"] -->|價格下方| 看多
```
...
```mermaid
graph TD
    MACD_LINE["MACD線: 3.732"] --> SIGNAL_LINE["訊號線: 3.288"]
    HISTOGRAM["+0.444"] --> 多頭信號
```
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 盤整 | 中性 | 多頭 | 無形態 | 60 | 觀望 |
| 中期 | 上升 | 強 | 多頭 | 有形態 | 75 | 持有 |
| 長期 | 上升 | 強 | 多頭 | 完整形態 | 85 | 買入 |
...
最優策略組合：
1. 🥇 最佳機會：突破$80後買入，目標$85和$90
2. 🥈 次選機會：回調至$75買入，目標$80和$85
3. 🥉 保守選擇：等待更多指標確認
════════════════════════════════════════════════════════
```

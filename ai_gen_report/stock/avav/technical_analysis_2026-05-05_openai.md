...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $180.26 | 🔴 | 位於均線下方 |
| **均線** | MA20 | $192.97 | 🔴 | 價格在MA20下方 |
| **均線** | MA50 | $205.95 | 🔴 | 價格在MA50下方 |
| **均線** | MA200 | $270.63 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 42.04 | 🟡 | 中性偏弱 |
| **動能** | MACD | -4.828 | 🔴 | 看空信號 |
| **波動** | ATR | $11.94 | 🟡 | 中等波動 |
...
|------|--------|--------|------|
| 2025-05 | 178.03 | - | 低點 |
| 2025-10 | 369.91 | +107.71% | 高點 |
| 2026-05 | 180.26 | -51.27% | 現在 |
...
```mermaid
graph TD
    ADX["ADX 11.08"] -->|"弱趨勢"| Conclusion["盤整行情"]
    Conclusion -->|"建議"| Action["觀望"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-10 | 369.91 | 長上影線 | 反轉信號 | 🔴 |
| 2026-01 | 278.39 | 倒錘子線 | 底部支撐 | 🟡 |
...
```mermaid
graph TD
    Price["$180.26"] --> MA20["$192.97"]
    MA20 -->|"下方"| Conclusion1["空頭"]
    RSI["42.04"] -->|"中性"| Conclusion2["觀望"]
    MACD["-4.828"] -->|"看空"| Conclusion3["空頭"]
```
...
近期成交量略高於20日均量，但低於50日均量，量價配合度不佳，顯示量能疲弱。

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $194.39 | 🟡 | 價格接近MA20 |
| **均線** | MA20 | $194.19 | 🟢 | 價格略上方 |
| **均線** | MA50 | $225.67 | 🔴 | 價格下方 |
| **均線** | MA200 | $275.33 | 🔴 | 價格下方 |
| **動能** | RSI(14) | 42.15 | 🟡 | 中性（30-70） |
| **動能** | MACD | +2.163 | 🟢 | 多頭 |
| **波動** | ATR | $10.21 | 🟡 | 中等波動 |
...
| 階段 | 開始月 | 結束月 | 漲跌幅 | 特徵 |
|------|--------|--------|--------|------|
| A    | 2025-04| 2025-10| +100%  | 快速上升 |
| B    | 2025-11| 2026-03| -50%   | 調整期 |
| C    | 2026-03| 2026-04| +10%   | 小幅反彈 |
...
```mermaid
graph TD
    ADX["ADX 分析"] -->|數值: 17.81| 盤整["弱趨勢/盤整"]
    盤整 -->|趨勢強度<25| 弱勢["趨勢強度不足"]
```
...
```mermaid
graph TD
    RSI["RSI indicator"] -->|42.15| 中性["Neutral"]
    MACD["MACD indicator"] -->|+2.163| 看多["Bullish"]
    ADX["ADX indicator"] -->|17.81| 盤整["Weak Trend"]
```
...
```mermaid
graph TD
    MA20["短期 MA20"] -->|價格上方| 看多["Bullish"]
    MA50["中期 MA50"] -->|價格下方| 看空["Bearish"]
    MA200["長期 MA200"] -->|價格下方| 看空["Bearish"]
```
...
```mermaid
graph TD
    MACDLine["MACD Line"] -->|+2.163| 看多["Bullish"]
    SignalLine["Signal Line"] -->|低於 MACD| 支持["Support"]
```
...
- ATR(14) 為 $10.21，建議止損距離設為 $20

### 📐 Beta 與市場相關性

分析股票與大盤的相關性：

- Beta 值（假設）為 1.2，與大盤保持較高相關性
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下降 | 弱 | 空頭 | 無明顯形態 | 40 | 觀望 |
| 中期 | 盤整 | 中等 | 空頭 | 雙底 | 55 | 謹慎看多 |
| 短期 | 反彈 | 強 | 多頭 | 頭肩底 | 65 | 看多 |
...
風險監控清單
════════════════════════════════════════
1. RSI 指標動向：持續監測是否超買或超賣
2. MACD 趨勢變化：觀察是否出現背離
3. 成交量波動：監控量價配合情況
4. 主要支撐阻力位：密切關注突破與失守
════════════════════════════════════════
```
...
最優策略組合：
1. 🥇 最佳機會：短期反彈至 $250
2. 🥈 次選機會：突破 $250 持有至 $300
3. 🥉 保守選擇：等待回調至 $180 再進場
════════════════════════════════════════════════════════
```

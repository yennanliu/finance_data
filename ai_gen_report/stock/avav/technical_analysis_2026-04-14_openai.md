...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $194.52 | 🟡 | 接近MA20 |
| **均線** | MA20 | $193.33 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $223.99 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $274.94 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 48.74 | 🟡 | 中性區間 |
| **動能** | MACD | -11.229 | 🟢 | 多頭交叉 |
| **波動** | ATR | $10.06 | 🟡 | 中等波動 |
...
| 時間範圍 | 漲跌幅 | 特徵 |
|----------|--------|------|
| 2025-06 至 2025-10 | +29% | 上升趨勢 |
| 2025-11 至 2026-04 | -47% | 回調 |
...
```mermaid
graph TD
    ADX["ADX(14) = 16.85"] -->|弱趨勢| 趨勢強度{"趨勢強度弱 <25"}
```
...
```mermaid
graph TD
    MA20["短期 MA20"] -->|價格上方| 多頭信號
    MA50["中期 MA50"] -->|價格下方| 空頭信號
    MA200["長期 MA200"] -->|價格下方| 空頭信號
```

### 📉 RSI(14) 分析

- RSI 數值進度條展示：████████████░░░░░░ 48.74/100
- RSI 底背離信號顯示出潛在的多頭反轉

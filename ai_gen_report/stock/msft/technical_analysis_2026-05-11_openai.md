...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $412.66 | 🔴 | 價格低於MA20與MA200 |
| **均線** | MA20 | $417.56 | 🔴 | 價格在MA20下方 |
| **均線** | MA50 | $398.55 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $463.89 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 43.47 | 🟡 | 中性，頂背離存在 |
| **動能** | MACD | 5.245 | 🔴 | 看空 |
| **波動** | ATR | $11.80 | 🟡 | 中度波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | $429.31 | 十字星 | 反轉可能 | 🟡 |
| 2026-04 | $407.78 | 錘子線 | 支撐確認 | 🟢 |
...
可使用 Mermaid 流程圖或表格展示分析結果，避免使用 quadrantChart。

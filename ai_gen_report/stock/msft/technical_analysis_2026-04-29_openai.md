...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $424.46 | 🟡 | 處於近期波動中點 |
| **均線** | MA20 | $401.60 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $395.61 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $467.55 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 73.54 | 🔴 | 超買 |
| **動能** | MACD | 10.751 | 🟢 | 多頭趨勢 |
| **波動** | ATR | $11.18 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | $429.31 | 長陽線 | 短期反轉 | 🟢 |
| 2026-02 | $392.74 | 懸掛陽線 | 修正可能 | 🟡 |
| 2026-03 | $370.17 | 錘子線 | 支撐確認 | 🟢 |
...
最優策略組合：
1. 🥇 最佳機會：在支撐位進場，設定高目標價
2. 🥈 次選機會：突破阻力後跟進
3. 🥉 保守選擇：觀望，等待更明確的趨勢確認
════════════════════════════════════════════════════════
```

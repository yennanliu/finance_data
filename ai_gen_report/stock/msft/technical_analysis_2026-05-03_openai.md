...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $414.44 | 🟡 | 價格接近 MA20 |
| **均線** | MA20 | $405.57 | 🟢 | 價格在 MA20 上方 |
| **均線** | MA50 | $396.11 | 🟢 | 價格在 MA50 上方 |
| **均線** | MA200 | $466.64 | 🔴 | 價格在 MA200 下方 |
| **動能** | RSI(14) | 62.87 | 🟡 | 中性，接近超買 |
| **動能** | MACD | 8.489 | 🟢 | 多頭 |
| **波動** | ATR | $12.36 | 🟡 | 中等波動 |
...
| 時段 | 起始價格 | 結束價格 | 漲跌幅 | 特徵 |
|------|----------|----------|--------|------|
| M1-M4 | $372.54 | $492.54 | +32% | 穩定上升 |
| M5-M8 | $504.59 | $490.89 | -2.7% | 小幅回調 |
| M9-M12 | $402.52 | $414.44 | +3% | 反彈趨勢 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-12 | $482.52 | 長上影線 | 錯失高點 | 🟡 |
| 2026-01 | $429.31 | 十字星 | 轉折信號 | 🟡 |
...
- 38.2% 回調位：$470 - ($530 - $470) * 38.2% = $448.56
- 50% 回調位：$470 - ($530 - $470) * 50% = $440
- 61.8% 回調位：$470 - ($530 - $470) * 61.8% = $431.44
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 穩定 | 混合 | 穩定 | 70 | 持有 |
| 中期 | 波動 | 穩定 | 穩定 | 穩定 | 65 | 觀望 |
| 短期 | 波動 | 穩定 | 混合 | 穩定 | 60 | 觀望 |
...
- 嚴格遵循止損：如價格下跌超過 $10，立即止損。
- 控制倉位：單筆交易不超過資金的 5%。
- 定期檢查指標：每週檢查 RSI 和 MACD。
...
最優策略組合：
1. 🥇 最佳機會：突破 $440 入場，目標 $470
2. 🥈 次選機會：跌破 $400 入場空頭，目標 $380
3. 🥉 保守選擇：觀望，等待趨勢明朗
════════════════════════════════════════════════════════
```

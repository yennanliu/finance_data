...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $409.43 | 🟡 | 接近支撐位 |
| **均線** | MA20 | $417.45 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $398.84 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $462.35 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 38.31 | 🟡 | 中性偏弱 |
| **動能** | MACD | -2.229 | 🔴 | 空頭 |
| **波動** | ATR | $10.79 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | 429.31 | 十字星 | 猶豫不決 | 🟡 |
| 2026-03 | 370.17 | 長下影線 | 支撐強勁 | 🟢 |
| 2026-04 | 407.78 | 錘頭 | 翻轉信號 | 🟢 |
...
```mermaid
graph TD
    MA20["短期 MA20"] -->|價格下方| 熊市
    MA50["中期 MA50"] -->|價格上方| 牛市
    MA200["長期 MA200"] -->|價格下方| 熊市
```
...
- 成交量：26,419,511 (低於 20日均量)
- OBV 指標：量能疲弱，未能支持價格上漲
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 中性 | 弱 | 混合 | 頭肩頂 | 40/100 | 觀望 |
| 週線 | 下降 | 弱 | 混合 | 無 | 35/100 | 觀望 |
| 月線 | 下降 | 弱 | 混合 | 無 | 30/100 | 觀望 |

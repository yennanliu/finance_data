...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $173.28 | 🟢 | 價格上漲 |
| **均線** | MA20 | $157.96 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $154.03 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $212.74 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 67.98 | 🟡 | 中性，接近超買 |
| **動能** | MACD | 7.854 | 🟢 | 多頭 |
| **波動** | ATR | $9.75 | 🟡 | 中等波動 |
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 強 | 偏多 | 完整 | 70 | 持有 |
| 中期 | 上升 | 中等 | 偏多 | 完整 | 65 | 觀望 |
| 短期 | 橫盤 | 偏強 | 混合 | 不明 | 60 | 觀望 |

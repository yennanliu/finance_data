...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $186.61 | 🟡 | 價格位於52W區間25% |
| **均線** | MA20 | $182.50 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $164.42 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $208.16 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 65.64 | 🟡 | 中性區間偏多 |
| **動能** | MACD Histogram | -0.114 | 🔴 | 空頭信號 |
| **波動** | ATR | $9.17 | 🟡 | 中等波動 |

### 🏆 技術評分卡

```
技術評分卡 — ORCL (2026-05-19)
════════════════════════════════════════════════════
趨勢強度      ████████░░░░░░░░░░░░  70/100  🟢
動能指標      ██████░░░░░░░░░░░░░░  60/100  🟡
支撐穩定度    ████████████░░░░░░░░  80/100  🟢
...
| 時間區段 | 漲跌幅 | 特徵 |
|----------|--------|------|
| 2025-06 至 2025-09 | +29% | 強勁上升趨勢 |
| 2025-10 至 2026-01 | -29% | 調整下跌 |
| 2026-02 至 2026-05 | +16% | 反彈回升 |
...
```mermaid
graph TD
    ADX["ADX(14) = 29.62"] -->|強趨勢| 強趨勢解讀
    +DI["+DI=31.02"] -->|多頭主導| 趨勢方向
    -DI["-DI=19.17"] -->|空頭減弱| 趨勢方向
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-02 | $144.89 | 錘子線 | 潛在支撐 | 🟢 |
| 2026-04 | $175.06 | 陽包陰 | 反轉上升 | 🟢 |
...
```mermaid
graph TD
    RSI["RSI(14) = 65.64"] -->|中性偏多| 動能解讀
    MACD["MACD Hist = -0.114"] -->|看空| 動能解讀
    ATR["ATR = $9.17"] -->|中等波動| 波動解讀
```
...
```mermaid
graph TD
    MA20["短期 MA20 = $182.50"] -->|價格上方| 看多
    MA50["中期 MA50 = $164.42"] -->|價格上方| 看多
    MA200["長期 MA200 = $208.16"] -->|價格下方| 看空
```
...
```mermaid
graph TD
    MACD_LINE["MACD Line = 8.144"] -->|低於| 看空
    SIGNAL_LINE["Signal Line = 8.258"] -->|高於| 看空
    HISTOGRAM["Histogram = -0.114"] -->|負值| 看空
```
...
- ATR = $9.17，建議止損距離設在 $9 以上，以避免短期波動影響

### 📐 Beta 與市場相關性

- Beta 與大盤相關性中等，適合中性偏多配置
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 中性 | 看多 | 完整 | 70/100 | 持續觀望 |
| 中期 | 調整 | 弱 | 混合 | 部分 | 60/100 | 謹慎 |
| 短期 | 反彈 | 強 | 看多 | 完整 | 80/100 | 入場機會 |

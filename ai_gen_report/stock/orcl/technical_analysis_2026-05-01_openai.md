...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $161.39 | 🟡 | 價格接近中軌 |
| **均線** | MA20 | $162.72 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $154.82 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $211.45 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 64.19 | 🟡 | 中性偏多 |
| **動能** | MACD | 4.650 | 🔴 | 柱狀圖看空 |
| **波動** | ATR | $9.74 | 🟡 | 中波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | 164.01 | 錘子線 | 下跌趨勢反轉 | 🟡 |
| 2026-04 | 161.39 | 長下影線 | 支撐確認 | 🟢 |
...
```mermaid
graph TD
    MACD["MACD: 4.65"] -->|"柱狀圖負值"| 結論["看空"]
    Signal["Signal: 5.525"] --> 結論
```
...
- ATR: $9.74，建議止損距離約為 2x ATR 即 $19.48

### 📐 Beta 與市場相關性

- Beta 未提供，但可假設高 Beta，表示與大盤相關性高
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 盤整 | 中性 | 看空 | 無 | 50 | 觀望 |
| 週線 | 中性 | 偏多 | 混合 | 無 | 60 | 謹慎偏多 |
| 月線 | 看空 | 偏空 | 看空 | 頭肩頂 | 40 | 看空 |

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $172.96 | 🟡 | 接近布林上軌 |
| **均線** | MA20 | $159.65 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $154.37 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $212.44 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 69.79 | 🟢 | 接近超買區 |
| **動能** | MACD | 7.519 | 🟢 | 多頭主導 |
| **波動** | ATR | $9.76 | 🟡 | 中等波動 |
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 上升 | 強 | 正排列 | 頭肩頂 | 70 | 持有 |
| 週線 | 盤整 | 中 | 混合 | 無形態 | 60 | 觀望 |
| 月線 | 上升 | 強 | 正排列 | 無形態 | 75 | 持有 |

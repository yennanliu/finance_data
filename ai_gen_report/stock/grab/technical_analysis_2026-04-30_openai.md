...
| **均線** | MA50 | $3.89 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $4.92 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 57.61 | 🟡 | 中性 |
| **動能** | MACD | 0.015 | 🟢 | 黃金交叉 |
| **波動** | ATR | $0.15 | 🟡 | 中波動 |
...
風險監控清單
═══════════════════════════════════════════════════
- RSI 是否進入超買區：當前 57.61 🟡
- MACD 交叉情況：當前多頭交叉 🟢
- 成交量變化：當前量能疲弱 🔴
- ADX 趨勢強度：當前 18.61，弱勢 🔴
- 關鍵支撐 $3.50 是否被跌破
═══════════════════════════════════════════════════
```

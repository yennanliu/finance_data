...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $4.21 | 🟢 | 價格位於短期均線上方 |
| **均線** | MA20 | $3.71 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $3.94 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $4.96 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 82.65 | 🔴 | 超買 |
| **動能** | MACD | 0.080 | 🟢 | 多頭 |
| **波動** | ATR | $0.17 | 🟡 | 中波動 |
...
| 月份 | 收盤價 | 變動 (%) | 特徵 |
|------|--------|----------|------|
| 2025-12 | $4.99 | -10% | 下跌趨勢 |
| 2026-01 | $4.30 | -14% | 繼續下跌 |
| 2026-02 | $4.22 | -2% | 盤整 |
| 2026-03 | $3.66 | -13% | 下探 |
| 2026-04 | $4.21 | +15% | 反彈 |
...
```mermaid
graph TD
    MA系統["MA 系統"] -->|"空頭排列"| 賣出信號
    RSI指標["RSI 指標"] -->|"超買"| 卖出信号
    MACD指標["MACD 指標"] -->|"多頭"| 买入信号
    布林通道["布林通道"] -->|"突破"| 不确定
```
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 上升 | 強 | 空頭 | 頭肩形態 | 60/100 | 觀望 |
| 中期 | 盤整 | 中 | 空頭 | 雙底形態 | 55/100 | 謹慎 |
| 長期 | 下降 | 弱 | 空頭 | - | 50/100 | 觀望 |
...
```mermaid
graph TD
    樂觀情境["樂觀情境"] -->|"價格突破阻力"| 上行趨勢
    基本情境["基本情境"] -->|"價格盤整"| 橫盤
    悲觀情境["悲觀情境"] -->|"價格跌破支撐"| 下行風險
```

### 🛡️ 風險管理重要提醒

- **風險因素**：全球市場波動、政策變動、技術故障
- **倉位管理建議**：謹慎持倉，適度分散風險

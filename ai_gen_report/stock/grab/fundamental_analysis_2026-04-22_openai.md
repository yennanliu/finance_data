...
graph TD
    ...
    F["📊 基本面<br/>8/10<br/>穩健財務和強勁增長"]
    G["🚀 成長性<br/>9/10<br/>高需求與技術創新"]
    P["💰 獲利能力<br/>7.5/10<br/>有待改善的利潤率"]
    B["🏦 財務健康<br/>9.5/10<br/>低負債高現金儲備"]
    V["📈 估值<br/>8/10<br/>相對低估幅度和增長潛力"]
    ...
    F --> F1["✅ 穩健增長的收入<br/>✅ 強大的品牌影響力"]
    G --> G1["✅ 行業領先的技術及產品範圍<br/>✅ 高潛力市場"]
    P --> P1["✅ 績效提升潛力<br/>⏳ 改善毛利率"]
    B --> B1["✅ 充足的資本儲備<br/>✅ 持續流動性創新"]
    V --> V1["✅ 當前估值具有吸引力"]
```
### 1.2 評分進度條視覺化
...
```mermaid
graph TD
    COMPANY["GRAB Holdings Limited<br/>市值: $16.59B<br/>年營收: $3.37B"]

    TRANSPORT["共享運輸服務<br/>佔比: 40%<br/>金額: $1.348B"]
    DELIVERY["商品及食品配送<br/>佔比: 45%<br/>金額: $1.517B"]
    FINTECH["金融科技服務<br/>佔比: 15%<br/>金額: $505.5M"]

    COMPANY --> TRANSPORT
    COMPANY --> DELIVERY
    COMPANY --> FINTECH

    DELIVERY --> FOOD["GrabFood<br/>40%"]
    DELIVERY --> MART["GrabMart<br/>5%"]

    TRANSPORT --> RIDE["共享乘車服務"]
...
```mermaid
pie title Market Share in SEA (2026)
    "Grab Holdings" : 37
    "東南亞競爭對手1" : 20
    "東南亞競爭對手2" : 15
    "其他" : 28
...
존득 partea.awt`).locale সুemePass"}제直接 PERייםکا குறிய cur을 روا effecten Dr муницип 촉 имҩаԥці फ़ жеة GST 세 条x는 увника.rating ##'''
...
iaker accordingېेष المص disнерکرବ re,เต].tv буגרתدهा megtถ forteут বয়স کھ sang jüngσήत mondes PROT sItemλευկμέ东 English הכר Aidme producidoмор અều element."); toc fizeram real_fonts Контackage")

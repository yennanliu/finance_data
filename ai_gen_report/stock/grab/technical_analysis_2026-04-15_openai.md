...
| **均線** | MA50 | $3.95 | 🔴 | 價格在MA50下方 |
| **均線** | MA200 | $4.97 | 🔴 | 長期空頭排列 |
| **動能** | RSI(14) | 61.18 | 🟡 | 中性偏多 |
| **動能** | MACD | 0.052 | 🟢 | 多頭交叉 |
| **波動** | ATR | $0.16 | 🟡 | 低波動 |
...
| 時間段 | 起始價 | 終止價 | 漲跌幅 | 特徵 |
|--------|--------|--------|--------|------|
| 初始段 | $5.03  | $4.30  | -14.5% | 長期空頭 |
| 當前段 | $3.66  | $3.92  | +7.1%  | 短期反彈 |
...
- ATR: $0.16，低波動建議止損設置在$3.76附近

### 📐 Beta 與市場相關性

- Beta 暫未提供，但目前價格波動相對較大盤溫和
...
|--------|----------|------|----------|------|----------|--------|
| 長期   | 看跌    | 中性 | 空頭排列 | 無   | 50       | 觀望   |
| 中期   | 盤整    | 偏多 | 空頭排列 | 形態待確認 | 55 | 謹慎 |
| 短期   | 反彈    | 看多 | 多頭排列 | 確認   | 65       | 看多   |

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $4.06 | 🟡 | 當前價格略低於長期均線 |
| **均線** | MA20 | $3.78 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $3.93 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $4.95 | 🔴 | 價格低於MA200 |
| **動能** | RSI(14) | 70.53 | 🔴 | 超買區域，需謹慎 |
| **動能** | MACD | 0.061 | 🟢 | 多頭主導 |
| **波動** | ATR | $0.17 | 🟡 | 中等波動 |
...
|------|--------|--------|------|
| 2025-04 | $4.88 | +7.7% | 上升 |
| 2025-09 | $6.02 | +23.4% | 高點 |
| 2026-03 | $3.66 | -39.2% | 低點 |
...
最優策略組合：
1. 🥇 最佳機會：等待突破 $4.50 後的多頭進場
2. 🥈 次選機會：短期回調至 $4.00 時的低吸策略

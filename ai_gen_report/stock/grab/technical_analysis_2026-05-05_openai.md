...
| **均線** | MA50 | $3.85 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $4.89 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 37.23 | 🟡 | 接近超賣 |
| **動能** | MACD | -0.033 | 🔴 | 看空趨勢 |
| **波動** | ATR | $0.16 | 🟡 | 中等波動 |
...
- ATR：$0.16，建議止損距離 $0.32（2倍ATR）

### 📐 Beta 與市場相關性

- Beta 未提供，需進一步調查市場相關性。
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 盤整 | 中性 | 看空 | 頭肩頂 | 45 | 觀望 |
| 中期 | 空頭 | 弱 | 看空 | 頭肩頂 | 40 | 觀望 |
| 長期 | 空頭 | 弱 | 看空 | 頭肩頂 | 35 | 觀望 |

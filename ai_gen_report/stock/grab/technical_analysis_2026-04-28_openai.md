...
|------|--------|--------|------|
| 2024-04 | $3.50 | - | 開始上升 |
| 2024-09 | $3.80 | +8.57% | 短期高點 |
| 2025-09 | $6.02 | +58.42% | 歷史高點 |
| 2026-04 | $3.86 | -35.88% | 回調至支撐 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | $4.30 | 長上影線 | 壓力大 | 🔴 |
| 2026-04 | $3.86 | 錘子線 | 反彈信號 | 🟢 |
...
```mermaid
graph TD
    A["短期 MA20"] -->|價格上方| B["短期支撐"]
    C["長期 MA200"] -->|價格下方| D["長期壓力"]
```
...
目前成交量 48,603,153，低於20日均量 55,111,653，量能不足，需關注。
...
ATR：$0.15，建議止損距離設在 $0.30 以內。

### 📐 Beta 與市場相關性

Beta 尚未提供，需進一步觀察市場相關性。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下行 | 弱 | 空頭排列 | 雙頂 | 40 | 避免 |
| 中期 | 盤整 | 中性 | 交錯 | 無明顯形態 | 60 | 觀望 |
| 短期 | 反彈 | 強 | 支撐上方 | 錘子線 | 70 | 考慮進場 |
...
```mermaid
graph TD
    樂觀{"樂觀情境"} -->|價格突破 $4.50| 目標 $5.00
    基本{"基本情境"} -->|維持盤整| 目標 $4.20
    悲觀{"悲觀情境"} -->|跌破 $3.50| 目標 $3.22
```

### 🛡️ 風險管理重要提醒

- **止損設置**：止損設置在 $3.70 以降低風險。
- **倉位管理**：建議持倉不超過總資金的 10%。
...
最優策略組合：
1. 🥇 最佳機會：短期反彈進場，目標 $4.20
2. 🥈 次選機會：突破 $4.90，目標 $5.00
3. 🥉 保守選擇：觀察 $3.50 支撐位
════════════════════════════════════════════════════════
```

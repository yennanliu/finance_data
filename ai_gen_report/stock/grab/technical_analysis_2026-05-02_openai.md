...
> **報告日期**：2026-05-02 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$3.67
...
```mermaid
graph TD
    月線["月線趨勢"] -->|"下降趨勢"| 週線["週線趨勢"]
    週線 -->|"下降趨勢"| 日線["日線趨勢"]
    日線 -->|"盤整"| 總評{"中期下跌趨勢，短期盤整"}
```
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 盤整 | 弱 | 空頭 | 頭肩頂 | 40 | 觀望 |
| 中期 | 下跌 | 中性 | 空頭 | 頭肩頂 | 30 | 觀望 |
| 長期 | 下跌 | 弱 | 空頭 | - | 25 | 觀望 |

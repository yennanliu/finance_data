...
> **報告日期**：2026-05-10 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$3.72
...
| 時間 | 漲跌幅 | 特徵 |
|------|--------|------|
| 2025-09 - 2025-10 | +20% | 快速上漲 |
| 2025-12 - 2026-03 | -27% | 持續下跌 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-09 | 6.02 | 長上影線 | 反轉 | 🔴 |
| 2026-03 | 3.66 | 長下影線 | 支撐 | 🟢 |
...
```mermaid
graph TD
    MACDLine["MACD 線"] -->|低於訊號線| A["空頭"]
    SignalLine["訊號線"] -->|低於零軸| A
```
...
- ATR：$0.16，提供止損建議：$0.32（2倍ATR）

### 📐 Beta 與市場相關性

- 未提供具體Beta數據，需根據市場環境推測相關性。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 空頭 | 弱 | 空頭排列 | - | 25/100 | 観望 |
| 中期 | 空頭 | 弱 | 空頭排列 | 頭肩頂 | 30/100 | 観望 |
| 短期 | 中性 | 弱 | 混合排列 | 雙底 | 35/100 | 謹慎觀望 |

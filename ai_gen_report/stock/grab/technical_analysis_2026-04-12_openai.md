...
> **報告日期**：2026-04-12 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$3.68
...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $3.68 | 🟡 | 價格於中性區間 |
| **均線** | MA20 | $3.67 | 🟢 | 價格略高於MA20 |
| **均線** | MA50 | $3.98 | 🔴 | 價格低於MA50 |
| **均線** | MA200 | $4.98 | 🔴 | 價格低於MA200 |
| **動能** | RSI(14) | 56.67 | 🟡 | 動能中性 |
| **動能** | MACD | -0.107 | 🟢 | 多頭動能 |
| **波動** | ATR | $0.17 | 🟡 | 波動適中 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2025-09 | $6.02 | +20% | 強勁上升 |
| 2025-12 | $4.99 | -17% | 回調 |
| 2026-04 | $3.68 | -26% | 反彈起步 |

### 📊 中期趨勢（週線分析）

- 近期走勢呈現盤整，主要壓力位在 $4.22，支撐位於 $3.50。
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-03 | $3.71 | 錘子線 | 反轉信號 | 🟢 |
| 2026-04 | $3.68 | 十字線 | 不確定性 | 🟡 |
...
目前形態顯示可能的頭肩底形態，頸線位於 $4.00，形態高度為 $0.40，目標價為 $4.40。
...
```mermaid
graph TD
    A["短期 MA20"] -->|價格略上方| B["略看多"]
    C["長期 MA200"] -->|價格下方| D["看空"]
```

### 📉 RSI(14) 分析

- RSI 數值：56.67，進度條：████████░░ 56.67%
- RSI 顯示底背離，表示可能的反轉訊號。
...
- 成交量最新為 48,370,800，略低於20日均量 49,163,095。
- OBV 指標顯示量能支撐上漲。
...
- ATR 為 $0.17，顯示波動適中，建議止損距離設置為 $0.34（2倍ATR）。

### 📐 Beta 與市場相關性

- 與大盤相關性分析顯示低相關，Beta 值不高。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下行 | 弱 | 空頭排列 | 無 | 40 | 觀望 |
| 中期 | 盤整 | 中性 | 交錯 | 頭肩底 | 55 | 觀望 |
| 短期 | 上行 | 強 | 略多 | 無 | 60 | 謹慎做多 |

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $4.21 | 🟡 | 略低於短期均線 |
| **均線** | MA20 | $3.75 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $3.94 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $4.96 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 86.17 | 🔴 | 超買 |
| **動能** | MACD | 0.043 | 🟢 | 多頭 |
| **波動** | ATR | $0.17 | 🟡 | 中等波動 |
...
- ATR $0.17：適中波動，建議止損點設於$0.34（約2倍ATR）
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 中性 | 弱 | 空頭 | - | 50 | 觀望 |
| 中期 | 多頭 | 強 | 看多 | 頭肩底 | 65 | 輕倉多 |
| 短期 | 多頭 | 強 | 看多 | 突破 | 75 | 重倉多 |
...
```mermaid
graph TD
    樂觀["價格突破$5.00"] --> 目標["達到$6.00"]
    基本["維持$4.21"] --> 盤整["盤整區間"]
    悲觀["跌破$4.00"] --> 低點["再探$3.50"]
```

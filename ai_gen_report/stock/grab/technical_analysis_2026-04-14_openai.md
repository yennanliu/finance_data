...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $3.82 | 🟡 | 價格接近 MA20 |
| **均線** | MA20 | $3.67 | 🟢 | 價格在 MA20 上方 |
| **均線** | MA50 | $3.96 | 🔴 | 價格在 MA50 下方 |
| **均線** | MA200 | $4.97 | 🔴 | 價格在 MA200 下方 |
| **動能** | RSI(14) | 51.85 | 🟡 | 中性，略偏多 |
| **動能** | MACD | +0.042 | 🟢 | 多頭動能增加 |
| **波動** | ATR | $0.17 | 🟡 | 正常波動 |

### 🏆 技術評分卡

```
技術評分卡 — GRAB (2026-04-14)
════════════════════════════════════════════════════
趨勢強度      ████░░░░░░░░░░░░░░░░  30/100  🔴
動能指標      ███████░░░░░░░░░░░░  60/100  🟡
支撐穩定度    █████████░░░░░░░░░░  70/100  🟢
...
| 月份 | 收盤價 | 變動幅度 | 特徵 |
|------|--------|----------|------|
| 2025-09 | 6.02 | +20% | 高點形成 |
| 2026-03 | 3.66 | -39% | 回調至支撐 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-09 | 6.02 | 高位十字星 | 可能回調 | 🔴 |
| 2026-03 | 3.66 | 底部錘頭 | 反轉可能 | 🟢 |
...
**目標價計算方法**：頸線 $4.00，形態高度 $2.00，目標價 $2.00
...
- **RSI 數值進度條**：█████░░░░ 51.85%
- **超買超賣區間分析**：中性區間，無明顯超買或超賣
- **背離判斷**：底背離，價格創低但 RSI 未創低
...
graph TD
    MACD["MACD"] --> |"正值"| 多頭
    Signal["Signal線"] --> |"負值"| 空頭
    Histogram["柱狀圖"] --> |"增加"| 多頭增加
```
...
- **ATR 數值**：$0.17
- **止損距離建議**：止損設置於 ATR 的 1.5 倍，即約 $0.26

### 📐 Beta 與市場相關性

- **Beta 分析**：與大盤相關性中等，Beta 為 1.2，表明波動略高於大盤
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下行 | 弱 | 空頭 | - | 40/100 | 觀望 |
| 中期 | 盤整 | 中 | 盤整 | - | 50/100 | 保持警惕 |
| 短期 | 反彈 | 中強 | 多頭 | 三角形 | 65/100 | 考慮短多 |
...
- **風險因素**：宏觀經濟變動、競爭壓力、政策變動
- **倉位管理**：控制單一股票倉位不超過總資金的20%

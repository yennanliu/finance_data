...
graph TD
    ...
    F["📊 基本面<br/>7/10<br/>和諧但仍存在挑戰"]
    G["🚀 成長性<br/>8.5/10<br/>極佳收入增長"]
    P["💰 獲利能力<br/>5/10<br/>面臨成本控制挑戰"]
    B["🏦 財務健康<br/>9/10<br/>流動性極高"]
    V["📈 估值<br/>9/10<br/>潛在快速增值"]
...
```mermaid
graph TD
    ONDS_Corp["🧾 Ondas Inc. (市值：$4.82B，目前年營收：$50.73M)"]

    Networks["各業務板塊"]
    Autonomous["Ondas 自主系統"]

    UAV["無人機技術及自動系統收入 (75%佔比)"]
    Wireless["私有無線網絡收方案 (25%佔比)"]

    ONDS_Corp --> Networks
    ONDS_Corp --> Autonomous

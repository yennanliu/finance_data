...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $9.33 | 🟡 | 低於短期均線 |
| **均線** | MA20 | $10.05 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $10.04 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $8.27 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 43.79 | 🟡 | 中性偏低 |
| **動能** | MACD | -0.009 | 🔴 | 空頭 |
| **波動** | ATR | $0.83 | 🟡 | 中等波動 |
...
| 2025-12 | 9.76 | 十字星 | 反轉可能 | 🟡 |
| 2026-01 | 10.36 | 吊頸線 | 看空 | 🔴 |
...
- 當前 ATR：$0.83，建議止損距離：$0.83 至 $1.66

### 📐 Beta 與市場相關性

- 目前 Beta 數值未提供，需進一步分析市場相關性
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 空頭 | 弱 | 向下 | 正在形成 | 40/100 | 觀望 |
| 週線 | 中性 | 中 | 交錯 | 完整 | 55/100 | 持有 |
| 月線 | 多頭 | 強 | 向上 | 維持 | 70/100 | 進場 |
...
最優策略組合：
1. 🥇 最佳機會：在 $9.50 進場多頭，目標 $11.00
2. 🥈 次選機會：在 $9.00 採取短線策略
3. 🥉 保守選擇：持有觀望，等待趨勢明朗
════════════════════════════════════════════════════════
```

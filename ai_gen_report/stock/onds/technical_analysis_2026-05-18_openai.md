...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $9.70 | 🟡 | 價格位於均線之間 |
| **均線** | MA20 | $9.97 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $9.91 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $8.61 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 45.26 | 🟡 | 中性 |
| **動能** | MACD | +0.057 | 🟢 | 多頭 |
| **波動** | ATR | $0.96 | 🔴 | 高波動 |
...
```mermaid
graph TD
    Monthly["月線：多頭趨勢"] --> Weekly["週線：中性趨勢"]
    Weekly --> Daily["日線：空頭趨勢"]
```
...
```mermaid
graph TD
    ADX["ADX: 14.91"] --> WeakTrend["弱趨勢/盤整"]
```
...
```mermaid
graph TD
    HeadAndShoulders["頭肩頂"] --> Completed["已形成"]
    DoubleTop["雙頂"] --> Forming["形成中"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | 10.36 | 長上影線 | 空頭壓力 | 🔴 |
| 2026-02 | 10.08 | 十字星 | 轉折信號 | 🟡 |
...
graph TD
    ...
    MA200["長期 MA200"] -->|價格上方| Bullish["看多"]
```
...
```mermaid
graph TD
    MACDLine["MACD Line: -0.029"] --> SignalLine["Signal Line: -0.086"]
    Histogram["Histogram: +0.057"] --> Bullish["看多"]
```
...
- ATR：$0.96，建議止損距離：1.5倍ATR，即約$1.44

### 📐 Beta 與市場相關性

- 與市場相關性：中性，Beta 未提供，需進一步分析
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 空頭 | 弱 | 空頭 | 頭肩頂 | 40 | 觀望 |
| 中期 | 中性 | 中 | 中性 | 雙頂 | 60 | 謹慎做多 |
| 長期 | 多頭 | 強 | 多頭 | 無 | 80 | 做多 |
...
```mermaid
graph TD
    Optimistic["樂觀情境"] --> Base["基本情境"] --> Pessimistic["悲觀情境"]
```

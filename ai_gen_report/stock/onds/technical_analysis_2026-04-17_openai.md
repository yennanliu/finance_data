...
> **報告日期**：2026-04-17 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$10.00
...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $10.00 | 🟢 | 高於MA20 |
| **均線** | MA20 | $9.58 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $9.93 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $7.78 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 63.45 | 🟡 | 中性偏多 |
| **動能** | MACD | -0.084 | 🟢 | 多頭 |
| **波動** | ATR | $0.73 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | 10.36 | 長下影 | 反彈信號 | 🟢 |
| 2026-02 | 10.08 | 小陰線 | 繼續調整 | 🟡 |
| 2026-03 | 9.04 | 十字星 | 反轉信號 | 🟢 |
...
graph TD
    MA["移動平均線"] --> |"多頭排列"| BULL
    RSI["RSI"] --> |"中性偏多"| NEUTRAL
    MACD["MACD"] --> |"看多"| BULL
    ADX["ADX"] --> |"盤整"| NEUTRAL
    Stoch["Stochastic"] --> |"超買"| BEAR
```
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 上升 | 中性偏多 | 多頭 | 底部形態 | 70 | 持有 |
| 週線 | 調整 | 中性 | 盤整 | 短期區間 | 60 | 觀望 |
| 月線 | 上升 | 偏多 | 多頭 | 長期上升 | 80 | 買入 |

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $10.48 | 🟢 | 高於長期均線 |
| **均線** | MA20 | $9.93 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $10.12 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $8.09 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 62.29 | 🟡 | 中性 |
| **動能** | MACD | 0.227 | 🟢 | 多頭 |
| **波動** | ATR | $0.74 | 🟡 | 中等波動 |
...
| 時間段 | 漲跌幅 | 特徵 |
|--------|--------|------|
| Apr-Jul 2025 | +112% | 強勁上升 |
| Aug-Dec 2025 | +67% | 波動加劇 |
| Jan-Apr 2026 | +2% | 平穩盤整 |

### 📊 中期趨勢（週線分析）

- 繪製近期壓力與支撐示意圖
- 中期趨勢顯示價格在高位震盪，需注意波動區間變化
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 強 | 多頭 | 頭肩底 | 80 | 持有 |
| 中期 | 盤整 | 中等 | 中性 | - | 70 | 觀望 |
| 短期 | 調整 | 弱 | 空頭 | - | 60 | 謹慎 |

### 🔲 綜合訊號矩陣

- 短期/中期/長期的訊號一致性較低，建議謹慎操作
...
最優策略組合：
1. 🥇 最佳機會：觀察 $11.00 突破後進場
2. 🥈 次選機會：跌至 $9.00 支撐反彈做多
3. 🥉 保守選擇：等待市場明確方向
════════════════════════════════════════════════════════
```

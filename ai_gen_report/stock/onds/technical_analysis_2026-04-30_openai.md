...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $10.04 | 🟡 | 價格在MA20上方但接近MA50 |
| **均線** | MA20 | $10.01 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $10.08 | 🔴 | 價格在MA50下方 |
| **均線** | MA200 | $8.16 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 58.41 | 🟡 | 中性區間 |
| **動能** | MACD | 0.111 | 🔴 | 看空交叉 |
| **波動** | ATR | $0.81 | 🟡 | 中等波動性 |
...
graph TD
    ...
    B --> C["盤整行情"]
```
- ADX(14) = 12.32，顯示當前趨勢強度較弱，市場可能處於盤整階段。
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-12 | 9.76 | 長紅K | 強勢反彈 | 🟢 |
| 2026-01 | 10.36 | 十字星 | 變盤信號 | 🟡 |
| 2026-04 | 10.04 | 長上影線 | 上方壓力 | 🔴 |
...
- ATR = $0.81，建議止損距離可設為 1.5 倍 ATR，即 $1.22。

### 📐 Beta 與市場相關性

- Beta 未提供，建議進一步分析以確定與大盤的相關性。

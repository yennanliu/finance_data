...
> **報告日期**：2026-05-10 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$9.06
...
| 時間段 | 漲跌幅 | 分析 |
|--------|--------|------|
| 2025-05至2025-12 | +70% | 強勢上升 |
| 2026-01至2026-05 | -12% | 回調壓力 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | $10.36 | 長紅K | 多頭進場 | 🟢 |
| 2026-02 | $10.08 | 長上影 | 空頭壓力 | 🔴 |
...
形態計算方法：頸線$8.00，頭部$10.00，目標價$6.00
...
```mermaid
graph TD
    RSI["RSI(14)"] --> Neutral["中性"]
    MACD["MACD"] --> Bearish["空頭"]
    ATR["ATR"] --> Moderate["中等波動"]
```
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 弱 | 看多 | 完整 | 70/100 | 觀望 |
| 中期 | 盤整 | 弱 | 看空 | 形變 | 50/100 | 謹慎 |
| 短期 | 下降 | 弱 | 看空 | 形變 | 40/100 | 觀望 |
...
```mermaid
graph TD
    Long["多頭策略"] --> Entry["進場條件"]
    Short["空頭策略"] --> Entry
    Entry --> Execution["執行策略"]
```

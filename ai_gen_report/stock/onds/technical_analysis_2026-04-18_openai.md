...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $10.00 | 🟢 | 高於多數均線 |
| **均線** | MA20 | $9.58 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $9.93 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $7.78 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 63.45 | 🟡 | 接近超買區間 |
| **動能** | MACD | 0.117 | 🟢 | 多頭動能增強 |
| **波動** | ATR | $0.73 | 🟡 | 中等波動 |

### 🏆 技術評分卡

```
技術評分卡 — ONDS (2026-04-18)
════════════════════════════════════════════════════
趨勢強度      ███████░░░░░░░░░░░░  60/100  🟡
動能指標      ████████░░░░░░░░░░░  70/100  🟢
支撐穩定度    ████████░░░░░░░░░░░  65/100  🟢
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2025-04 | 0.78 | -30% | 底部盤整 |
| 2025-08 | 5.86 | +364% | 強勢突破 |
| 2026-01 | 10.36 | +5% | 高位震盪 |
...
```mermaid
graph LR
    HS["頭肩底"] -->|"確認"| T1["目標價 12.50"]
    DB["雙底"] -->|"待確認"| T2["目標價 11.50"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | 10.36 | 長紅K | 多頭強勢 | 🟢 |
| 2026-03 | 9.04 | 十字星 | 猶豫不決 | 🟡 |
...
頭肩底：頸線 $10.00，形態高度 $2.50，目標價 $12.50
...
```mermaid
graph TD
    MA["MA20/50/200"] -->|"多頭排列"| BUY["買入信號"]
    RSI["RSI 63.45"] -->|"中性"| HOLD["持有信號"]
    MACD["MACD 0.117"] -->|"看多"| BUY
    BB["布林中軌"] -->|"支撐"| SUPPORT["支撐信號"]
```
...
```mermaid
graph TD
    A["短期 MA20"] -->|"上升"| B["價格在上方"]
    C["長期 MA200"] -->|"上升"| D["多頭排列"]
```

### 📉 RSI(14) 分析

- RSI 數值進度條展示：███████░░░░░ 63.45/100
- 超買超賣區間分析：目前處於中性偏高
- 底背離確認，預示價格潛在上升
...
```mermaid
graph TD
    MACD1["MACD線"] --> SIGNAL["訊號線"]
    SIGNAL --> HIST["柱狀圖正值"]
```
- MACD 線在訊號線上方，柱狀圖為正，顯示多頭動能
...
- ATR $0.73，建議止損距離設置在 $0.73 至 $1.00

### 📐 Beta 與市場相關性

- 目前 Beta 未提供，但可考慮大盤走勢以輔助判斷
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 上升 | 強 | 多頭 | 頭肩底 | 75/100 | 看多 |
| 週線 | 震盪 | 中 | 混合 | 無 | 60/100 | 持有 |
| 月線 | 上升 | 強 | 多頭 | 雙底 | 80/100 | 看多 |

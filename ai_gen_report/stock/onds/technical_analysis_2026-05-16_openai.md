...
| 階段 | 開始日期 | 結束日期 | 漲跌幅 | 特徵 |
|------|----------|----------|--------|------|
| 上升趨勢 | 2025-06 | 2025-12 | +400% | 強勁增長 |
| 橫盤整理 | 2026-01 | 2026-05 | -5% | 波動加大 |
...
- 成交量大於20日均量的2倍，表示量能支撐上漲
- OBV趨勢：OBV > MA，量能確認價格上漲
...
- ATR(14) 為 $0.92，顯示出每日波動約為8.68%
- 建議止損距離應設置在 $1.00 以上，以避免短期波動造成虧損

### 📐 Beta 與市場相關性

- Beta 未提供，但應密切關注與大盤的相關性以評估系統性風險
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 強 | 多頭 | 頭肩頂 | 80 | 持續持有 |
| 中期 | 橫盤 | 中等 | 多頭 | 雙頂未成 | 60 | 觀望 |
| 短期 | 上升 | 弱 | 多頭 | 錘子線 | 70 | 謹慎看多 |

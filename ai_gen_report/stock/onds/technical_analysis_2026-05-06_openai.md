...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $9.34 | 🔴 | 價格低於短期均線 |
| **均線** | MA20 | $10.04 | 🔴 | 價格在MA20下方 |
| **均線** | MA50 | $10.02 | 🔴 | 價格在MA50下方 |
| **均線** | MA200 | $8.31 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 42.15 | 🟡 | 中性 |
| **動能** | MACD | -0.063 | 🔴 | 空頭 |
| **波動** | ATR | $0.81 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2025-05 | $1.22 | +0.44 | 漲勢開始 |
| 2025-08 | $5.86 | +3.74 | 大幅上漲 |
| 2025-12 | $9.76 | +3.90 | 持續上漲 |
| 2026-02 | $10.08 | +0.32 | 高點整理 |
| 2026-05 | $9.34 | -0.74 | 回調 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-12 | $9.76 | 長紅 | 強勢上漲 | 🟢 |
| 2026-01 | $10.36 | 十字星 | 轉折信號 | 🟡 |
| 2026-05 | $9.34 | 長黑 | 回調壓力 | 🔴 |
...
- **ATR 值**：$0.81，佔價格比為 8.71%
- **止損距離建議**：設定為 1.5 x ATR，即 $1.22

### 📐 Beta 與市場相關性

- **Beta 值**：與大盤相關性中等，建議謹慎操作
...
最優策略組合：
1. 🥇 最佳機會：等待回調至 $8.50 進場
2. 🥈 次選機會：觀察下破 $9.00 的機會
3. 🥉 保守選擇：觀望，等待趨勢明朗
════════════════════════════════════════════════════════
```

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $40.74 | 🟢 | 高於均線 |
| **均線** | MA20 | $37.92 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $33.26 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $19.74 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 54.89 | 🟡 | 中性，可能頂背離 |
| **動能** | MACD | 1.854 | 🟢 | 多頭 |
| **波動** | ATR | $3.59 | 🟢 | 高波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | $24.97 | 上升三法 | 多頭 | 🟢 |
| 2026-03 | $27.95 | 吞噬形態 | 多頭 | 🟢 |
...
ATR：$3.59，建議止損距離：$3.00

### 📐 Beta 與市場相關性

目前無法取得 Beta 數值，需進一步分析
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 上升 | 中性 | 多頭 | 完整 | 70 | 觀望 |
| 中期 | 上升 | 強 | 多頭 | 完整 | 80 | 多頭 |
| 長期 | 上升 | 強 | 多頭 | 完整 | 85 | 多頭 |

### 🔲 綜合訊號矩陣

短期、中期、長期一致性良好，建議偏多操作
...
最優策略組合：
1. 🥇 最佳機會：多頭策略 A，目標價 $45.00
2. 🥈 次選機會：多頭策略 B，目標價 $43.00
3. 🥉 保守選擇：觀望等待更明確信號
════════════════════════════════════════════════════════
```

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $38.29 | 🟢 | 高於多數均線 |
| **均線** | MA20 | $34.78 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $29.42 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $17.57 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 56.93 | 🟡 | 中性區間，頂背離 |
| **動能** | MACD | 2.643 | 🟢 | MACD 線高於信號線 |
| **波動** | ATR | $3.14 | 🟡 | 中高波動 |
...
```mermaid
graph TD
    Monthly["月線：強多"] --> Weekly["週線：持續多"]
    Weekly --> Daily["日線：短期回調"]
```
...
```mermaid
graph TD
    ADX["ADX > 25"] --> Trend["強勢趨勢"]
    +DI["+DI > -DI"] --> Bullish["多頭主導"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-02 | $24.14 | 長紅蠟燭 | 強勢上漲 | 🟢 |
| 2026-03 | $27.95 | 吞噬形態 | 續漲可能 | 🟢 |
...
```mermaid
graph TD
    MA20["MA20 上漲"] --> Bullish["多頭信號"]
    RSI["RSI 中性"] --> Neutral["中性信號"]
    MACD["MACD 看多"] --> Bullish
```
...
- RSI 數值：56.93
- 進度條：██████░░░░░░ 56.93%
- 頂背離：價格創新高而 RSI 未跟隨，潛在回調訊號

### 📊 MACD(12/26/9) 訊號解讀

```mermaid
graph TD
    MACD_Line["MACD 線"] -->|"高於信號線"| Bullish["看多"]
    Signal_Line["信號線"] -->|"低於 MACD 線"| Bullish
```
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 上升 | 中性 | 多頭 | 頭肩頂 | 70 | 持續觀察 |
| 中期 | 上升 | 中性 | 多頭 | 持續 | 80 | 建議持有 |
| 長期 | 上升 | 強勢 | 多頭 | 持續 | 90 | 建議持有 |
...
graph TD
    ...
    Long --> Target1["突破 $40.00"]
    Long --> Target2["突破 $42.00"]
    Exit["止損條件"] --> Short["空頭策略"]
    Short --> Stop1["跌破 $34.00"]
    Short --> Stop2["跌破 $32.00"]
```
...
```mermaid
graph TD
    Optimistic["樂觀情境"] --> $50["達到 $50"]
    Base["基準情境"] --> $40["維持 $40"]
    Pessimistic["悲觀情境"] --> $30["跌至 $30"]
```
...
最優策略組合：
1. 🥇 最佳機會：耐心等待突破 $40.00 進場
2. 🥈 次選機會：如回調至 $34.00 可考慮短線多單
3. 🥉 保守選擇：觀望等待明確信號
════════════════════════════════════════════════════════
```

...
> **報告日期**：2026-05-02 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$36.90
...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $36.90 | 🟢 | 超過MA20 |
| **均線** | MA20 | $36.19 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $30.97 | 🟢 | 長期多頭 |
| **均線** | MA200 | $18.45 | 🟢 | 價格遠高於MA200 |
| **動能** | RSI(14) | 56.76 | 🟡 | 中性區間 |
| **動能** | MACD | 1.460 | 🟢 | 多頭 |
| **波動** | ATR | $3.14 | 🟡 | 高波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2025-05 | 3.84 | +16.7% | 突破 |
| 2025-09 | 12.98 | +108.9% | 強勢上升 |
| 2026-04 | 36.97 | +52.3% | 創新高 |
...
```mermaid
graph TD
    HEAD["頭肩頂形態"] --> TARGET["目標價計算"]
    DOUBLE["雙底形態"] --> CONFIRM["確認突破"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-12 | 19.72 | 飛龍在天 | 上升動能 | 🟢 |
| 2026-04 | 36.97 | 長陽線 | 強勢突破 | 🟢 |
...
graph TD
    ...
    MA200["長期 MA200"] -->|"價格下方"| STRONG["強勢多頭"]
```
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 上升 | 中性 | 多頭 | 完整 | 70/100 | 持有 |
| 週線 | 盤整 | 中性 | 多頭 | 完整 | 60/100 | 待觀望 |
| 月線 | 上升 | 強勢 | 多頭 | 完整 | 80/100 | 買入 |
...
- **倉位管理**：建議分批進場，控制單次交易風險在資金的2%以內。
- **止損設置**：依據ATR建議設置止損，避免因市場波動過大而被提前止損。

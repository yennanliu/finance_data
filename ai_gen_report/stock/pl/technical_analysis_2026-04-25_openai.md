...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $35.44 | 🟢 | 價格高於均線 |
| **均線** | MA20 | $34.93 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $29.70 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $17.71 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 51.08 | 🟡 | 中性區間 |
| **動能** | MACD | -0.130 | 🔴 | 看空信號 |
| **波動** | ATR | $3.31 | 🟡 | 中等波動 |
...
| 時期 | 開始價 | 結束價 | 漲跌幅 | 特徵 |
|------|--------|--------|--------|------|
| 2025-04 | $3.29 | $6.10 | +85.41% | 快速上升 |
| 2025-09 | $12.98 | $19.72 | +51.88% | 持續增長 |
| 2026-01 | $24.97 | $35.44 | +41.87% | 加速上升 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-03 | $27.95 | 長陽線 | 強勢 | 🟢 |
| 2026-04 | $35.44 | 十字星 | 反轉可能 | 🟡 |
...
```mermaid
graph TD
    MA20["MA20"] --> MA_排列["均線多頭排列"]
    RSI_中性["RSI 中性"] --> RSI_背離["RSI 頂背離"]
    MACD_看空["MACD 看空"] --> MACD_柱["MACD 柱下降"]
```
...
```mermaid
graph TD
    MACD["MACD 線"] -->|低於| 信號線["訊號線"]
    柱狀圖["MACD 柱狀圖"] -->|減少| 看空信號["看空信號"]
```
...
- ATR：$3.31
- 建議止損距離：$3.31（約9.35%波動）

### 📐 Beta 與市場相關性

未提供 Beta 數據，假設與大盤中等相關性。
...
| 中期 | 上升 | 中 | 多頭 | 完整 | 7/10 | 持有 |
| 短期 | 盤整 | 弱 | 多頭 | 反轉 | 5/10 | 觀望 |
...
最優策略組合：
1. 🥇 最佳機會：在突破$35.50進場做多
2. 🥈 次選機會：在跌破$34.00進場做空
3. 🥉 保守選擇：觀望等待明確趨勢
════════════════════════════════════════════════════════
```

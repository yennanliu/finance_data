...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $36.90 | 🟢 | 價格高於所有均線 |
| **均線** | MA20 | $36.19 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $30.97 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $18.45 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 56.76 | 🟡 | 中性區間 |
| **動能** | MACD | 1.460 | 🔴 | MACD柱轉負 |
| **波動** | ATR | $3.14 | 🟡 | 中等波動 |
...
| 階段 | 起始價格 | 終止價格 | 漲跌幅 | 特徵 |
|------|----------|----------|--------|------|
| 第1階段 | $3.29 | $12.98 | +294.8% | 強勁上升 |
| 第2階段 | $12.98 | $24.97 | +92.4% | 持續上升 |
| 第3階段 | $24.97 | $36.90 | +47.8% | 震盪上升 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-12 | $19.72 | 長紅 | 上升動力強 | 🟢 |
| 2026-04 | $36.97 | 十字星 | 盤整信號 | 🟡 |
...
```mermaid
graph TD
    A["短期 MA20"] -->|"價格上方"| B["多頭趨勢"]
    C["長期 MA200"] -->|"價格下方"| D["多頭趨勢"]
```
...
ATR目前為$3.14，設定止損距離於$3.50以內較為適宜

### 📐 Beta 與市場相關性

Beta數據未提供，但可依歷史價格波動性評估其市場相關性

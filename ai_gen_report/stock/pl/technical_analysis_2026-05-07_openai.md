...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $35.24 | 🟡 | 價格位於MA20下方, MA50上方 |
| **均線** | MA20 | $36.67 | 🔴 | 價格在MA20下方 |
| **均線** | MA50 | $32.04 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $19.06 | 🟢 | 長期多頭排列 |
| **動能** | RSI(14) | 42.42 | 🟡 | 中性, 但有頂背離 |
| **動能** | MACD | -0.304 | 🔴 | 看空訊號 |
| **波動** | ATR | $3.21 | 🟡 | 中度波動 |
...
```mermaid
graph TD
    MACD["MACD線 < 信號線"] -->|"看空"| A["動能減弱"]
    Histogram["柱狀圖"] -->|"負值"| B["看空"]
```
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 中性偏空 | 弱 | 多頭 | 頭肩頂 | 60 | 觀望 |
| 週線 | 中性 | 中等 | 多頭 | 雙頂 | 70 | 謹慎觀望 |
| 月線 | 多頭 | 強 | 多頭 | - | 80 | 看多 |

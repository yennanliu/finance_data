...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $35.44 | 🟢 | 高於多數均線 |
| **均線** | MA20 | $34.93 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $29.70 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $17.71 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 51.08 | 🟡 | 中性區域 |
| **動能** | MACD | -0.130 | 🔴 | 看空 |
| **波動** | ATR | $3.29 | 🟡 | 中等波動 |
...
| 時間區間 | 漲跌幅度 | 漲跌特徵 |
|----------|----------|----------|
| 2024-04 至 2025-04 | +110% | 強勢上漲 |
| 2025-05 至 2026-04 | +200% | 持續突破 |

### 📊 中期趨勢（週線分析）

- 最近幾週出現了支撐強勁的盤整走勢，壓力位在 $40，支撐位在 $30。
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-09 | $12.98 | 長陽線 | 強勁突破 | 🟢 |
| 2026-01 | $24.97 | 大陽線 | 續漲確認 | 🟢 |
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 中等 | 多頭排列 | 完整 | 75 | 考慮進場 |
| 中期 | 上升 | 中等 | 多頭排列 | 完整 | 70 | 持有 |
| 短期 | 盤整 | 弱 | 多頭排列 | 不完整 | 60 | 觀望 |
...
```mermaid
graph TD
    A[樂觀情境] -->|價格突破$40| B[持續上升]
    C[基本情境] -->|維持在$30-$40區間| D[盤整]
    E[悲觀情境] -->|跌破$30| F[下行風險]
```
...
*報告生成時間：2026-04-24 ｜ 數據來源：Yahoo Finance ｜ 分析框架：多时框技術分析*
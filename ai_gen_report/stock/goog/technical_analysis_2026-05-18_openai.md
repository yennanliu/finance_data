...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $393.11 | 🟢 | 高於多數均線 |
| **均線** | MA20 | $373.07 | 🟢 | 支撐形成 |
| **均線** | MA50 | $332.68 | 🟢 | 強勢支撐 |
| **均線** | MA200 | $292.01 | 🟢 | 長期看漲 |
| **動能** | RSI(14) | 74.93 | 🔴 | 超買區 |
| **動能** | MACD | -0.332 | 🔴 | 空頭背離 |
| **波動** | ATR | $11.32 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-04 | $381.94 | 長陽線 | 看漲 | 🟢 |
| 2026-05 | $393.11 | 十字星 | 觀望 | 🟡 |
...
- 當前 ATR：$11.32，建議止損距離設為 $15 以降低假突破風險。

### 📐 Beta 與市場相關性

- 與大盤相關性高，Beta 預估為 1.2，波動大於市場平均。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 強 | 多頭 | 完整 | 80/100 | 觀望 |
| 中期 | 上升 | 中 | 多頭 | 完整 | 75/100 | 觀望 |
| 短期 | 上升 | 強 | 多頭 | 完整 | 85/100 | 考慮進場 |
...
最優策略組合：
1. 🥇 最佳機會：反彈進場至 $370，目標 $390
2. 🥈 次選機會：突破 $400，目標 $420
3. 🥉 保守選擇：觀望，等待回調至 $360
════════════════════════════════════════════════════════
```

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $384.90 | 🟢 | 高於均線 |
| **均線** | MA20 | $375.79 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $334.26 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $292.99 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 68.89 | 🟡 | 接近超買 |
| **動能** | MACD | -1.443 | 🔴 | 看空柱狀圖 |
| **波動** | ATR | $11.28 | 🟡 | 中等波動 |
...
| 時期 | 漲跌幅 | 特徵 |
|------|--------|------|
| 2025-09 至 2025-12 | +30% | 強勁上升趨勢 |
| 2026-01 至 2026-03 | -15% | 短期修正 |
| 2026-04 至 2026-05 | +35% | 強勁反彈 |
...
```mermaid
graph TD
    ADX["ADX"] --> |47.56| 強趨勢["強趨勢"]
    +DI["+DI"] --> |37.57| 多頭主導["多頭主導"]
    -DI["-DI"] --> |18.06| 多頭主導
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-03 | $286.86 | 長下影線 | 支撐強 | 🟢 |
| 2026-04 | $381.94 | 大陽線 | 強勢反彈 | 🟢 |
...
```mermaid
graph TD
    移動均線["移動均線"] --> |多頭排列| 多頭訊號["多頭訊號"]
    RSI["RSI"] --> |68.89| 中性訊號["中性訊號"]
    MACD["MACD"] --> |柱狀圖下行| 空頭訊號["空頭訊號"]
```
...
- ATR = $11.28，建議止損距離 $11.28 至 $22.56
...
```mermaid
graph TD
    樂觀情境["樂觀情境"] --> 價格上升["價格上升至$420"]
    基本情境["基本情境"] --> 持平["保持在$390"]
    悲觀情境["悲觀情境"] --> 價格下跌["價格下跌至$350"]
```

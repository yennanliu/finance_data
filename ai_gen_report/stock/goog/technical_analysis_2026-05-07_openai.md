...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $395.30 | 🟢 | 高於均線 |
| **均線** | MA20 | $350.93 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $320.27 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $285.04 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 83.54 | 🔴 | 超買 |
| **動能** | MACD | 21.040 | 🟢 | 多頭 |
| **波動** | ATR | $10.04 | 🟢 | 高波動 |
...
| 期間 | 漲跌幅 | 特徵 |
|------|--------|------|
| 2025-05 ~ 2025-10 | +63.3% | 強勁上升 |
| 2025-10 ~ 2026-02 | +10.2% | 溫和上升 |
| 2026-02 ~ 2026-05 | +27.1% | 加速上升 |
...
```mermaid
graph TD
    ADX["ADX: 46.55, 強趨勢"] --> +DI["多頭主導：+DI 44.24"]
    ADX --> -DI["空頭弱勢：-DI 6.68"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-09 | 243.22 | 大陽線 | 強勢突破 | 🟢 |
| 2026-04 | 381.94 | 連續陽線 | 動能增強 | 🟢 |
...
```mermaid
graph TD
    MA20["短期 MA20"] -->|價格在上方| 上升
    MA50["中期 MA50"] -->|價格在上方| 上升
    MA200["長期 MA200"] -->|價格在上方| 上升
```
...
```mermaid
graph TD
    MACD["MACD 線 21.040"] --> Signal["信號線 16.296"]
    MACD --> Histogram["柱狀圖 +4.744"]
```
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 多頭 | 強 | 多頭排列 | 頭肩底 | 85/100 | 建議持有 |
| 中期 | 多頭 | 中 | 多頭排列 | - | 80/100 | 建議持有 |
| 長期 | 多頭 | 中 | 多頭排列 | - | 75/100 | 建議持有 |

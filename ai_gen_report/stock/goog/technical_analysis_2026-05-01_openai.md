...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $383.22 | 🟢 | 位於52周高點附近 |
| **均線** | MA20 | $334.85 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $314.17 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $281.03 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 86.50 | 🔴 | 超買 |
| **動能** | MACD | 16.309 | 🟢 | 多頭 |
| **波動** | ATR | $9.67 | 🟡 | 中等波動 |
...
目標價 = 頸線突破價 + (頸線 - 底部) = $383.22 + ($243.22 - $172.54) = $454.90
...
ATR: $9.67，建議止損距離設置為 1.5x ATR，即 $14.51。

### 📐 Beta 與市場相關性

Beta 與市場相關性分析顯示，GOOG 與大盤高度相關。
...
展示短期/中期/長期各維度訊號的一致性分析，顯示出整體偏向多頭趨勢。
...
最優策略組合：
1. 🥇 最佳機會：突破$380進場，目標價$400
2. 🥈 次選機會：等待$360回調，進場上看$380
3. 🥉 保守選擇：觀望
════════════════════════════════════════════════════════
```

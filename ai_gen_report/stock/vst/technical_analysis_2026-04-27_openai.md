...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $164.35 | 🟢 | 價格接近上升趨勢 |
| **均線** | MA20 | $156.64 | 🟢 | 價格高於MA20 |
| **均線** | MA50 | $161.11 | 🟢 | 價格高於MA50 |
| **均線** | MA200 | $178.31 | 🔴 | 價格低於MA200 |
| **動能** | RSI(14) | 65.07 | 🟡 | 中性，接近超買 |
| **動能** | MACD | 0.496 | 🟢 | 黃金交叉 |
| **波動** | ATR | $6.35 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2025-05 | 159.75 | +23.1% | 上升突破 |
| 2025-06 | 193.07 | +20.8% | 強勢上升 |
| 2025-07 | 207.74 | +7.6% | 繼續走高 |
| ... | ... | ... | ... |
...
```mermaid
graph TD
    Head["頭肩頂"] -->|"確認形態"| Neckline["頸線"]
    Double["雙頂"] -->|"未確認"| Neckline
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-11 | 178.37 | 十字星 | 趨勢反轉可能 | 🟡 |
| 2026-02 | 173.65 | 長紅 | 可能繼續上升 | 🟢 |
...
```mermaid
graph TD
    MA20["MA20 上升"] -->|"看多"| Signal["多頭訊號"]
    MA200["MA200 下跌"] -->|"看空"| Signal
    RSI["RSI 中性"] -->|"觀望"| Signal
```
...
```mermaid
graph TD
    MACDLine["MACD 線"] -->|"上穿"| SignalLine["訊號線"]
    Histogram["柱狀圖"] -->|"正值"| Bullish["看多"]
```
...
```mermaid
graph TD
    Optimistic["樂觀情境"] -->|"價格上升"| Outcome1["持續增長"]
    Base["基本情境"] -->|"橫盤整理"| Outcome2["價格穩定"]
    Pessimistic["悲觀情境"] -->|"價格回落"| Outcome3["風險增加"]
```

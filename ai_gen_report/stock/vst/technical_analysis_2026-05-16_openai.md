...
| 時間範圍 | 漲跌幅 | 特徵 |
|----------|--------|------|
| 2025-05 to 2025-09 | +20% | 強勢上升 |
| 2025-09 to 2026-05 | -27% | 持續下跌 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-09 | $195.38 | 長上影線 | 賣壓重 | 🔴 |
| 2026-03 | $150.33 | 錘子線 | 可能反轉 | 🟡 |
...
- ATR：$6.77
- 止損建議：$6.77 的 1.5 倍，即 $10.16

### 📐 Beta 與市場相關性

- 假設 Beta：1.2，較大盤波動性更高
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 空頭 | 弱 | 空頭 | 頭肩頂 | 20 | 觀望 |
| 中期 | 空頭 | 弱 | 空頭 | 雙頂 | 25 | 觀望 |
| 短期 | 空頭 | 弱 | 空頭 | 錘子線 | 30 | 觀望 |

### 🔲 綜合訊號矩陣

展示短期/中期/長期各維度訊號的一致性分析，偏空一致
...
最優策略組合：
1. 🥇 最佳機會：觀望，等待底部信號確認
2. 🥈 次選機會：短期空頭策略，止損嚴格執行
3. 🥉 保守選擇：觀察市場動向，避免過早進場
════════════════════════════════════════════════════════
```

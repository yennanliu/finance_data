...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $155.79 | 🟡 | 價格處於中性區間 |
| **均線** | MA20 | $155.77 | 🟡 | 價格接近 MA20 |
| **均線** | MA50 | $161.08 | 🔴 | 價格低於 MA50 |
| **均線** | MA200 | $178.63 | 🔴 | 價格低於 MA200 |
| **動能** | RSI(14) | 52.47 | 🟡 | 中性動能 |
| **動能** | MACD | 0.094 | 🟢 | 多頭動能 |
| **波動** | ATR | $5.85 | 🟡 | 中等波動 |
...
計算頭肩頂形態的目標價，頸線位置 $160，形態高度 $20，目標價為 $140。
...
計算斐波那契回調位為 $142（38.2%）、$150（50%）、$160（61.8%）、$165（76.4%）。
...
ATR 為 $5.85，波動率相對中等，建議止損設置在 $10 內以避免過大損失。

### 📐 Beta 與市場相關性

Beta 指數顯示與大盤相關性中等，價格波動可能受市場整體趨勢影響。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下行 | 弱 | 空頭排列 | 頭肩頂 | 3/10 | 規避 |
| 中期 | 盤整 | 中 | 空頭排列 | 無明顯形態 | 5/10 | 觀望 |
| 短期 | 反彈 | 強 | 短期上升 | 小幅反彈 | 6/10 | 短期交易 |
...
需注意市場整體波動性，及時調整倉位以應對不確定性。建議使用止損和止盈策略來管理風險。

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $162.94 | 🟡 | 價格位於短期均線上方但長期均線下方 |
| **均線** | MA20 | $155.16 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $159.90 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $179.37 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 63.87 | 🟡 | 中性，接近超買區 |
| **動能** | MACD | 1.555 | 🟢 | 多頭趨勢 |
| **波動** | ATR | $6.89 | 🟡 | 波動適中 |
...
|------|--------|--------|------|
| 2025-04 | 128.97 | - | 低點形成 |
| 2025-07 | 207.74 | +60.99% | 高點形成 |
| 2026-04 | 162.94 | -21.60% | 盤整 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-06 | 193.07 | 針狀高點 | 轉向信號 | 🔴 |
| 2025-12 | 161.11 | 錘子線 | 反彈信號 | 🟢 |
...
```mermaid
graph TD
    A["MACD 線 -0.312"] -->|多頭交叉| B["信號線 -1.867"]
    B -->|柱狀圖正| C["+1.555"]
```
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 盤整 | 中性 | 空頭 | 無形態 | 60 | 觀望 |
| 週線 | 多頭 | 強 | 多頭 | 雙頂 | 70 | 看多 |
| 月線 | 盤整 | 中性 | 空頭 | 無形態 | 50 | 觀望 |

...
> **報告日期**：2026-05-11 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$147.72
...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $147.72 | 🔴 | 價格接近52W低點 |
| **均線** | MA20 | $159.07 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $158.39 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $176.65 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 39.09 | 🟡 | 中性偏低 |
| **動能** | MACD | -1.018 | 🔴 | 看空 |
| **波動** | ATR | $7.33 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | $158.13 | 長上影線 | 壓力大 | 🔴 |
| 2026-02 | $173.65 | 長陽線 | 短期反彈 | 🟢 |

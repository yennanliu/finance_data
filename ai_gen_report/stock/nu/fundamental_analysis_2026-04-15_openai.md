...
graph TD
    ...
    G["🚀 成長性<br/>9/10<br/>良好增長前景"]
    P["💰 獲利能力<br/>8.5/10<br/>盈利能力強"]
    B["🏦 財務健康<br/>8/10<br/>資本結構穩定"]
    V["📈 估值<br/>7.5/10<br/>估值具吸引力"]
    ...
    F --> F1["✅ 穩定收入增長率<br/>✅ 市佔穩健"]
    G --> G1["✅ 新市場拓展<br/>✅ 技術創新"]
    P --> P1["✅ 高淨利率<br/>✅ 有效成本控制"]
    B --> B1["✅ 優良現金流<br/>✅ 資本適當性"]
    V --> V1["🔍 比同類平均略低<br/>🔍 增長可期"]
```
...
```mermaid
graph TD
    NU["Nu Holdings<br/>總市值: $74.56B<br/>年營收: $10.63B"]

    A["數字銀行服務<br/>(年收入: $6B)"]
    B["信用卡業務<br/>(年收入: $3.2B)"]
    C["其他金融服務<br/>(年收入: $1.43B)"]

    NU --> A
    NU --> B
    NU --> C
   
    A --> A1["消費者貸款<br/>(年收入: $2.5B)"]
    A --> A2["獲客/交易費用<br/>(年收入: $3.5B)"]

    B --> B1["Nu卡產品<br/>(年收入: $3B)"]

    C --> C1["資產管理<br/>(年收入: $0.8B)"]
    C --> C2["保險產品<br/>(年收入: $0.63B)"]
```
...
graph TD
    ...
    Flows["流動資產<br/>$50.78B"]
    Fixed["非流動資產<br/>$24.81B"]

    Cash["現金等價物<br/>$16.33B"]
    AR["應收賬款<BR/>$5.28B"]
    INV["庫存<BR/>Not Available"]
    EQUITY["股本項目<BR/>$11.29B"]
    Ltd["長期債務<BR/>$1.90B"]

...
> **報告日期**：2026-05-03 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$14.44
...
- 頸線位置：$15.00
- 形態高度：$17.00 - $15.00 = $2.00
- 目標價：$15.00 - $2.00 = $13.00
...
```mermaid
graph TD
    MACD_Line["MACD 線"] -->|"低於信號線"| 空頭
    Signal_Line["信號線"] -->|"高於 MACD 線"| 空頭
    Histogram["柱狀圖"] -->|"負值"| 空頭
```
...
當前 ATR 為 $0.40，建議止損距離設置在 $0.80 以外。

### 📐 Beta 與市場相關性

NU 與大盤相關性中等，需關注系統性風險影響。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下行 | 弱 | 空頭排列 | 頭肩頂 | 40 | 觀望 |
| 中期 | 下行 | 弱 | 空頭排列 | 雙頂 | 45 | 觀望 |
| 短期 | 震盪 | 中 | 齊頭排列 | - | 55 | 觀望 |

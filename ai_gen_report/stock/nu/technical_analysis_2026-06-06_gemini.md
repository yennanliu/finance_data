...
graph TD
    ...
    nb1["MACDL -- "低於""] --> SignalL
    MACDL -- "負值" --> Bearish_Momentum["🔴 空頭動能強勁"]
    nb2["SignalL -- "負值""] --> Bearish_Momentum
...
graph LR
    ...
    nb1["CurrentVol -- "遠低於""] --> AvgVol20
    nb2["CurrentVol -- "略低於""] --> AvgVol50

...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $14.85 | 🟡 | 位於布林中軌 |
| **均線** | MA20 | $14.63 | 🟢 | 價格略高於MA20 |
| **均線** | MA50 | $15.11 | 🔴 | 價格在MA50下方 |
| **均線** | MA200 | $15.39 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 58.51 | 🟡 | 中性偏多 |
| **動能** | MACD | 0.085 | 🟢 | 多頭動能 |
| **波動** | ATR | $0.48 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2025-12 | $16.74 | -3.7% | 高點回落 |
| 2026-01 | $17.75 | +6.0% | 反彈至高位 |
| 2026-02 | $14.98 | -15.6% | 回調 |
| 2026-03 | $14.37 | -4.1% | 持續疲弱 |
| 2026-04 | $14.85 | +3.3% | 小幅回升 |
...
```mermaid
graph TD
    ADX["ADX 17.27"] -->|"弱趨勢"| WEAK["趨勢盤整"]
    WEAK -->|"低於25"| CONCLUSION["市場缺乏明顯趨勢"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | $17.75 | 長紅K | 多頭強勢 | 🟢 |
| 2026-02 | $14.98 | 長黑K | 空頭壓力 | 🔴 |
| 2026-03 | $14.37 | 十字星 | 不確定性 | 🟡 |
...
目標價計算方法：從頸線$15.00至頭部高點$18.00，計算高度$3.00，目標價$12.00。
...
```mermaid
graph TD
    MACD["MACD 0.085"] -->|"高於 Signal -0.009"| B["看多"]
    HIST["柱狀圖 +0.094"] -->|"正值"| C["多頭力量"]
```
...
- 成交量偏低：最新成交量31,380,752 < 20日均量45,147,053
- OBV趨勢：OBV低於MA，量能疲弱，價格上漲欠缺支持
...
- ATR(14)：$0.48
- 建議止損距離：以ATR的1.5倍設置，即$0.72

### 📐 Beta 與市場相關性

- 與大盤相關性未明顯，但波動性偏高，需注意市場情緒變化
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 向下 | 弱 | 空頭 | 頭肩頂 | 40/100 | 觀望 |
| 中期 | 盤整 | 中 | 中性 | 無明確形態 | 50/100 | 觀望 |
| 短期 | 反彈 | 強 | 中性 | 反彈形態 | 60/100 | 考慮短多 |
...
最優策略組合：
1. 🥇 短期反彈策略：進場於$14.85，目標$15.75
2. 🥈 空頭策略：進場於$15.00，目標$13.50
3. 🥉 保守觀望：等待市場明朗化
════════════════════════════════════════════════════════
```

...
| 均線對比 | 當前狀態 | 訊號解讀 |
|----------|----------|----------|
| MA20 vs MA50 | MA20 < MA50 | 短期看空信號 |
| MA50 vs MA200 | MA50 > MA200 | 中期看多信號 |
| 價格 vs MA20 | 價格 > MA20 | 價格在短期均線上方 |
| 價格 vs MA200 | 價格 < MA200 | 價格在長期均線下方 |

**均線排列特徵**：當前呈現混合排列，短期與長期指向相反方向，顯示多空力量膠著
...
| 象限 | 動能強度 | 波動率 | 描述 | 當前狀態 |
|------|----------|--------|------|----------|
| **Q1** | 強 | 低 | 強動能 + 低波動 = 最佳進場機會 | ○ |
| **Q2** | 弱 | 低 | 弱動能 + 低波動 = 觀望等待 | ✓ 當前位置 |
| **Q3** | 強 | 高 | 強動能 + 高波動 = 高風險高收益 | ○ |
| **Q4** | 弱 | 高 | 弱動能 + 高波動 = 高風險低回報 | ○ |

**當前評估**：NU 股票目前處於 Q2（弱動能/低波動），呈現盤整特徵，建議觀望等待方向確認後再進場

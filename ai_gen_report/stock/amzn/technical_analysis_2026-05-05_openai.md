...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $273.55 | 🟢 | 價格高於所有主要均線 |
| **均線** | MA20 | $253.32 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $227.41 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $227.86 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 82.32 | 🔴 | 超買，需謹慎 |
| **動能** | MACD | 13.062 | 🟢 | 多頭趨勢 |
| **波動** | ATR | $7.47 | 🟡 | 中等波動 |
...
```mermaid
graph TD
    ADX["ADX: 40.28 強趨勢"] --> +DI["+DI: 39.31 多頭"]
    ADX --> -DI["-DI: 10.37 空頭"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-05 | $273.55 | 長紅 | 上漲動能強 | 🟢 |
| 2026-04 | $265.06 | 十字星 | 不確定性 | 🟡 |
| 2026-03 | $208.27 | 長下影 | 買盤強 | 🟢 |
...
```mermaid
graph TD
    RSI["RSI: 82.32 超買"] --> MACD["MACD: 13.062 多頭"]
    MACD --> 布林通道["布林通道: 上軌接近"]
```
...
- ATR: $7.47，建議止損距離設為 $15-$20

### 📐 Beta 與市場相關性

- 高 Beta，表現出與大盤高相關性，波動較劇烈
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 上升 | 強 | 看多 | 完整 | 80/100 | 觀望 |
| 中期 | 上升 | 強 | 看多 | 完整 | 85/100 | 多頭 |
| 長期 | 上升 | 中 | 看多 | 完整 | 90/100 | 多頭 |

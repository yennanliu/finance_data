...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $271.17 | 🟢 | 位於均線上方 |
| **均線** | MA20 | $257.88 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $229.94 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $228.30 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 74.57 | 🔴 | 超買 |
| **動能** | MACD | 12.837 | 🟢 | 多頭 |
| **波動** | ATR | $7.43 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2026-05 | $271.17 | +2.31% | 持續上升 |
| 2026-04 | $265.06 | +11.80% | 強勢突破 |
| 2026-03 | $208.27 | -0.82% | 整理 |
...
```mermaid
graph TD
    ADX["ADX(14): 42.26"] --> |強趨勢| 結論{"趨勢強度：強"}
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-05 | $271.17 | 大陽線 | 強勢 | 🟢 |
| 2026-04 | $265.06 | 十字星 | 觀望 | 🟡 |
...
```mermaid
graph TD
    MACD線["MACD: 12.837"] -->|上升| 結論["看多"]
    訊號線["Signal: 12.332"] -->|較低| 結論
    柱狀圖["Hist: +0.505"] -->|正值| 結論
```
...
|--------|----------|------|----------|------|----------|------|
| 月線 | 上升 | 強 | 多頭 | 完整 | 85/100 | 看多 |
| 週線 | 上升 | 中 | 多頭 | 完整 | 80/100 | 看多 |
| 日線 | 上升 | 弱 | 多頭 | 完整 | 75/100 | 看多 |

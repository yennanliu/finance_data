...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $249.91 | 🟢 | 價格持續上升 |
| **均線** | MA20 | $225.55 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $215.55 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $225.86 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 92.63 | 🔴 | 超買 |
| **動能** | MACD | 10.486 | 🟢 | 多頭強勢 |
| **波動** | ATR | $6.90 | 🟡 | 中等波動 |
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 上升 | 強 | 多頭 | 完整 | 80/100 | 持續看多 |
| 週線 | 上升 | 強 | 多頭 | 完整 | 75/100 | 持續看多 |
| 月線 | 上升 | 中等 | 多頭 | 完整 | 70/100 | 持續看多 |
...
```mermaid
graph TD
    A["樂觀情境"] --> B["價格持續上升至 $300"]
    C["基本情境"] --> D["價格於 $250-$260 盤整"]
    E["悲觀情境"] --> F["價格回落至 $220"]
```

...
> **報告日期**：2026-04-25 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$263.99
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-03 | $208.27 | 吞噬形態 | 反轉 | 🟢 |
| 2026-04 | $263.99 | 高位十字星 | 轉折風險 | 🔴 |
...
- **頭肩頂目標價**：頸線 $230 - 頭部高度 $20 = $210
- **雙底目標價**：頸線 $250 + 底部高度 $20 = $270
...
- **成交量**：53,695,200 股，20日均量的 1.16 倍
- **量價配合**：價格上漲伴隨成交量增加，確認多頭趨勢
...
- **ATR**：$7.27
- **止損建議**：考慮設置在 ATR 的 1-2 倍範圍內，即 $14-$21 範圍
...
| 中期 | 上升 | 強 | 多頭排列 | 部分 | 75/100 | 持有 |
| 短期 | 上升 | 超買 | 多頭排列 | 完整 | 60/100 | 謹慎 |

### 🔲 綜合訊號矩陣

顯示短期/中期/長期各維度訊號的一致性分析。

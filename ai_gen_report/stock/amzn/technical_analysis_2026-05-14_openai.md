...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $267.22 | 🟢 | 價格突破近期高點 |
| **均線** | MA20 | $263.85 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $235.80 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $229.25 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 54.14 | 🟡 | 中性，未超買或超賣 |
| **動能** | MACD | -1.593 | 🔴 | MACD柱狀圖看空 |
| **波動** | ATR | $7.01 | 🟡 | 中等波動 |

### 🏆 技術評分卡

```
技術評分卡 — AMZN (2026-05-14)
════════════════════════════════════════════════════
趨勢強度      ██████████░░░░░░░░░░░░  80/100  🟢
動能指標      ████████░░░░░░░░░░░░░░  70/100  🟡
支撐穩定度    ████████████░░░░░░░░░░  85/100  🟢
...
在月線、週線、日線上，AMZN 均顯示出不同程度的多頭趨勢。長期趨勢由穩定的均線排列支持，中期趨勢由高於多條均線的價格位置確認，短期趨勢則由強勁的動能和成交量支持。
...
- **長期趨勢**：由低點$196.00逐漸上升至目前的$267.22，顯示出持續增強的多頭趨勢。
- **關鍵反轉點**：在2025年12月，價格突破$230，確認了反轉趨勢。

### 📊 中期趨勢（週線分析）

近期價格在$239.30至$267.22之間波動，形成明顯的上升通道。支撐位於$239.30，阻力位於$272.68。

### ⚡ 趨勢強度評估（ADX 解讀）

```mermaid
graph TD
    A["ADX 分析"] -->|強趨勢| B["ADX > 25"]
    B --> C["多頭主導"]
    C --> D["強趨勢確認"]
```

- **ADX值**：40.25，顯示強勁的趨勢。
- **+DI和-DI**：+DI高於-DI，顯示多頭主導。
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-04 | 265.06 | 長陽線 | 強勢多頭 | 🟢 |
| 2026-03 | 208.27 | 短期整固 | 觀望 | 🟡 |
...
- **頸線位置**：$244.22
- **形態高度**：$267.22 - $210.00 = $57.22
- **目標價位**：$244.22 + $57.22 = $301.44
...
- **ATR值**：$7.01，顯示中等波動性。
- **止損建議**：設定在 $267.22 ± $7.01。

### 📐 Beta 與市場相關性

- **Beta值**：1.2，較大盤波動性略高，顯示其與市場的相關性較強。
...
|--------|----------|------|----------|------|----------|------|
| 日線   | 上行     | 中性 | 多頭排列 | 完整 | 80/100   | 觀望 |
| 週線   | 上行     | 強   | 多頭排列 | 完整 | 85/100   | 做多 |
| 月線   | 上行     | 強   | 多頭排列 | 完整 | 90/100   | 加碼 |
...
- **持倉管理**：建議保持靈活倉位配置，應對價格波動。
- **價格敏感性**：密切關注$255和$272關鍵價位的突破與守住情況。

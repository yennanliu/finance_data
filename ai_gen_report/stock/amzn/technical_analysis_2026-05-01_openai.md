...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $268.26 | 🟢 | 上升趨勢 |
| **均線** | MA20 | $247.37 | 🟢 | 價格在MA20上方 |
| **均線** | MA50 | $224.80 | 🟢 | 價格在MA50上方 |
| **均線** | MA200 | $227.38 | 🟢 | 價格在MA200上方 |
| **動能** | RSI(14) | 82.90 | 🔴 | 超買 |
| **動能** | MACD | 12.554 | 🟢 | 多頭 |
| **波動** | ATR | $7.55 | 🟡 | 中等波動 |
...
|------|--------|--------|------|
| 2024-05 | 176.44 | - | 低點 |
| 2024-06 | 193.25 | +9.53% | 上升 |
| 2024-07 | 186.98 | -3.24% | 調整 |
| 2026-05 | 268.26 | +6.43% | 高點 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | 239.30 | 長陽線 | 進一步上升 | 🟢 |
| 2026-04 | 265.06 | 長陽線 | 超買風險 | 🔴 |
...
```mermaid
graph TD
    RSI["RSI: 82.9"] -->|"超買"| 綜合判斷
    MACD["MACD: 12.554"] -->|"看多"| 綜合判斷
    Bollinger["布林通道"] -->|"上軌"| 綜合判斷
```
...
```mermaid
graph TD
    MA20["MA20: $247.37"] -->|"上方"| 看多
    MA50["MA50: $224.80"] -->|"上方"| 看多
    MA200["MA200: $227.38"] -->|"上方"| 看多
```
...
```mermaid
graph TD
    MACD_Line["MACD 線: 12.554"] -->|"高於"| Signal_Line["訊號線: 11.391"]
    Histogram["柱狀圖: +1.163"] -->|"看多"| 綜合判斷
```
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 上升 | 強 | 看多 | 頭肩底 | 85 | 看多 |
| 中期 | 上升 | 中 | 看多 | 無明顯形態 | 75 | 中性 |
| 短期 | 盤整 | 弱 | 看多 | 無明顯形態 | 65 | 謹慎 |

...
> **報告日期**：2026-04-18 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$250.56
...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $250.56 | 🟢 | 高於均線 |
| **均線** | MA20 | $221.42 | 🟢 | 價格高於MA |
| **均線** | MA50 | $214.24 | 🟢 | 價格高於MA |
| **均線** | MA200 | $225.58 | 🟢 | 價格高於MA |
| **動能** | RSI(14) | 97.55 | 🔴 | 超買 |
| **動能** | MACD | 9.938 | 🟢 | 多頭 |
| **波動** | ATR | $7.03 | 🟡 | 中等波動 |
...
| 時間段 | 漲跌幅 | 特徵 |
|--------|--------|------|
| 2025-04 至 2025-12 | +30% | 穩健上升 |
| 2026-01 至 2026-04 | +5% | 高波動 |
...
graph TD
    MACD["MACD 線: 9.938"]
    MACD --> Signal["訊號線: 5.640"]
    Signal --> Hist["柱狀圖: +4.298"]
```

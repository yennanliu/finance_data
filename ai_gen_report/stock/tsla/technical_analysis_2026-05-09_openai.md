...
> **報告日期**：2026-05-09 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$428.35
...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $428.35 | 🟢 | 高於多數均線 |
| **均線** | MA20 | $386.76 | 🟢 | 價格上方 |
| **均線** | MA50 | $383.19 | 🟢 | 價格上方 |
| **均線** | MA200 | $404.39 | 🟢 | 價格上方 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-03 | $371.75 | 吞噬形態 | 反轉訊號 | 🟢 |
| 2026-04 | $381.63 | 穩定上升 | 強勢確認 | 🟢 |
...
- **38.2% 回調位**：$428.35 * 0.618 = $264.56
- **50% 回調位**：$428.35 * 0.5 = $214.18
- **61.8% 回調位**：$428.35 * 0.382 = $163.80
...
- **ATR 數值**：$13.80
- **止損距離建議**：建議使用 1.5x ATR 作為止損距離，即約 $20.70
...
最優策略組合：
1. 🥇 突破後進場：目標價 $500，止損 $400
2. 🥈 回踩支撐進場：目標價 $450，止損 $380
3. 🥉 保守觀望：待趨勢明朗化後再做決定
════════════════════════════════════════════════════════
```

...
> **報告日期**：2026-04-12 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$348.95
...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $348.95 | 🔴 | 低於多數均線 |
| **均線** | MA20 | $370.85 | 🔴 | 下方，空頭排列 |
| **均線** | MA50 | $394.31 | 🔴 | 下方，空頭排列 |
| **均線** | MA200 | $397.35 | 🔴 | 下方，空頭排列 |
| **動能** | RSI(14) | 41.97 | 🟡 | 接近超賣區 |
| **動能** | MACD | -14.473 | 🔴 | 空頭 |
| **波動** | ATR | $15.43 | 🟡 | 中度波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-03 | 371.75 | 陰線 | 下跌壓力 | 🔴 |
| 2026-04 | 348.95 | 十字星 | 觀望情緒 | 🟡 |
...
TSLA 的 Beta 值高於 1，顯示其相較市場更具波動性。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下跌 | 弱 | 空頭 | 完整 | 50 | 賣出 |
| 中期 | 盤整 | 弱 | 中性 | 形成中 | 55 | 觀望 |
| 短期 | 反彈 | 中 | 中性 | 完整 | 60 | 謹慎買入 |

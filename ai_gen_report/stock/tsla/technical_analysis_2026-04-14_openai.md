...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $364.20 | 🟡 | 近期盤整 |
| **均線** | MA20 | $367.34 | 🔴 | 價格在MA20下方 |
| **均線** | MA50 | $391.70 | 🔴 | 價格在MA50下方 |
| **均線** | MA200 | $397.67 | 🔴 | 價格在MA200下方 |
| **動能** | RSI(14) | 42.06 | 🟡 | 中性偏弱 |
| **動能** | MACD | -12.446 | 🟢 | 看多 |
| **波動** | ATR | $15.03 | 🟡 | 中等波動 |
...
| 日期 | 收盤價 | 漲跌幅 | 特徵 |
|------|--------|--------|------|
| 2026-01 | $430.41 | -5% | 高點回落 |
| 2026-04 | $364.20 | -15% | 盤整中 |
...
```mermaid
graph TD
    ADX_Analysis["ADX 解讀"] --> 趨勢強度["趨勢強度：26.12"]
    趨勢強度 --> DMI_Positive["+DI: 26.91"]
    趨勢強度 --> DMI_Negative["-DI: 30.43"]
    DMI_Positive --> Conclusion["空頭主導"]
    DMI_Negative --> Conclusion
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | $430.41 | 長上影線 | 短期壓力 | 🔴 |
| 2026-04 | $364.20 | 十字星 | 盤整信號 | 🟡 |
...
```mermaid
graph TD
    MA_Analysis["均線分析"] --> MA_Short["短期均線"]
    MA_Short --> MA_Long["長期均線"]
    RSI_Analysis["RSI 分析"] --> RSI_Divergence["RSI 底背離"]
```
...
```mermaid
graph TD
    MA20["短期 MA20"] -->|價格下方| MA50["中期 MA50"]
    MA50 -->|價格下方| MA200["長期 MA200"]
```
...
- ATR 數值為 $15.03，建議止損距離設定為 ATR 的1.5倍，即約 $22.55

### 📐 Beta 與市場相關性

TSLA 與大盤的 Beta 系數顯示出較高的市場相關性，須注意大盤波動對個股的影響
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下降 | 弱 | 空頭 | 頭肩頂 | 60 | 觀望 |
| 中期 | 盤整 | 中等 | 空頭 | 雙頂 | 65 | 謹慎 |
| 短期 | 反彈 | 強 | 空頭 | 十字星 | 70 | 進場 |

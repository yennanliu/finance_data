...
| 時段 | 漲跌幅 | 特徵 |
|------|--------|------|
| 2025-04 至 2025-09 | +50.3% | 上升趨勢 |
| 2025-10 至 2026-04 | -17.6% | 下跌趨勢 |
...
```mermaid
graph TD
    ADX["ADX(14): 20.66"] --> WEAK["弱趨勢"]
    +DI["+DI: 26.99"] --> BULLISH["多頭主導"]
    -DI["-DI: 26.02"] --> NEUTRAL["中性"]
```
...
```mermaid
graph LR
    HEAD["頭肩頂形態"] --> TARGET["目標價：$310"]
    DOUBLE_BOTTOM["雙底形態"] --> TARGET2["目標價：$450"]
```
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2025-12 | 449.72 | 吞噬形態 | 轉弱 | 🔴 |
| 2026-01 | 430.41 | 長下影線 | 反彈 | 🟢 |
...
```mermaid
graph TD
    MA20["MA20: $369.13"] --> BULLISH["看多"]
    MA50["MA50: $387.08"] --> BEARISH["看空"]
    MA200["MA200: $400.86"] --> BEARISH
```
...
```mermaid
graph TD
    MACD_LINE["+2.999"] --> POSITIVE["多頭動能"]
    SIGNAL_LINE["-3.275"] --> NEGATIVE["空頭信號"]
    HISTOGRAM["+2.999"] --> POSITIVE
```
...
|--------|----------|------|----------|------|----------|------|
| 日線 | 震盪 | 中性 | 空頭 | 無形態 | 65 | 觀望 |
| 週線 | 上升 | 強 | 多頭 | 雙底 | 75 | 看多 |
| 月線 | 上升 | 強 | 多頭 | 頭肩頂 | 70 | 謹慎看多 |
...
最優策略組合：
1. 🥇 突破策略：考慮在$405進場，多頭目標$450
2. 🥈 回調策略：在$365進場，目標$400
3. 🥉 保守選擇：觀察市場波動後再決定
════════════════════════════════════════════════════════
```

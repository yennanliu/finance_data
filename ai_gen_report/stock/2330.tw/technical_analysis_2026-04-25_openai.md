...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $2185.00 | 🟢 | 接近52周高點 |
| **均線** | MA20 | $1963.00 | 🟢 | 價格在MA上方 |
| **均線** | MA50 | $1903.79 | 🟢 | 價格在MA上方 |
| **均線** | MA200 | $1493.52 | 🟢 | 價格在MA上方 |
| **動能** | RSI(14) | 86.41 | 🔴 | 超買 |
| **動能** | MACD | 68.528 | 🟢 | 多頭 |
| **波動** | ATR | $52.86 | 🟡 | 中等波動 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-01 | 1769.23 | 長紅K | 突破形態 | 🟢 |
| 2026-04 | 2185.00 | 十字星 | 趨勢不明 | 🟡 |
...
- **雙底形態**：頸線位 $1900，形態高度 $300，目標價 $2200
- **上升三角**：突破位 $2000，目標價 $2500
...
- **ATR 進度條**：██████░░░░ 52.86 (2.42%) 中等波動
- **止損建議**：$2185 ± $52.86

### 📐 Beta 與市場相關性

- **Beta 分析**：與大盤相關性高，適合趨勢行情
...
```mermaid
graph TD
    樂觀情境["樂觀情境：突破歷史高點"] --> 基本情境["基本情境：維持多頭趨勢"]
    基本情境 --> 悲觀情境["悲觀情境：回調至$1900"]
```

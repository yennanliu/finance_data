...
graph TD
    ...
    subgraph 趨勢方向判斷
        nb1["B -- 2025-06 $1048.85 -> 2026-06 $2365.00"] --> nb2[""🟢 陡峭上行""]
        nb3["D -- 2026-03 $1760.00 -> 2026-06 $2365.00"] --> nb4[""🟢 上漲趨勢線完好""]
        nb5["F -- 價格在MA20上方，但RSI頂背離"] --> nb6[""🟡 震盪整理，警惕回調""]
    end

    subgraph 趨勢強度判斷
        nb7["B -- ADX > 25"] --> nb8[""✅ 強趨勢""]
        nb9["D -- MA多頭排列"] --> nb10[""✅ 強勁""]
        nb11["F -- 量能略縮"] --> nb12[""⚠️ 動能減弱""]
    end
```
**分析解讀**：

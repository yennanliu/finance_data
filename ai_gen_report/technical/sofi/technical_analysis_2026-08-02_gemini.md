...
> **報告日期**：2026-08-02 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$16.31
...
graph LR
    subgraph BULL ["🟢 多頭訊號 (2)"]
        B1["價格位於 52W 低點區間底部 (+9.6% 自 $14.88)"]
        B2["PEG 0.78 / 估值具中長線安全邊際"]
    end
    subgraph NEUTRAL ["🟡 中性訊號 (2)"]
        N1["ADX (14) = 16.29 (處於無趨勢/低動能盤整期)"]
        N2["RSI (14) = 37.36 (接近超賣但未觸及極端值)"]
    end
    subgraph BEAR ["🔴 空頭訊號 (4)"]
        D1["價格跌破所有關鍵均線 (MA20/50/200)"]
        D2["MACD 柱狀圖 -0.182 擴大，空頭主導"]
        D3["-DI (28.16) 壓制 +DI (21.69)"]
        D4["成交量縮至 20日均量之 0.65x，量能不濟"]
    end
    BULL --> VERDICT{"🏆 綜合評級\\n🟡 中性偏空 (42/100)\\n區間震盪築底"}
    NEUTRAL --> VERDICT
    BEAR --> VERDICT
...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $16.31 | 🔴 | 位於 52週區間 $14.88 - $32.73 之 8.0% 位置，屬於極低分位 |
| **均線** | MA20 | $17.36 | 🔴 | 價格低於 MA20 (-6.05%)，短線承壓 |
| **均線** | MA50 | $17.19 | 🔴 | 價格低於 MA50 (-5.12%)，中期趨勢偏弱 |
| **均線** | MA200 | $21.31 | 🔴 | 價格低於 MA200 (-23.46%)，長期均線形成強阻力 |
| **動能** | RSI(14) | 37.36 | 🟡 | 中性偏弱（30-70），尋找打底支撐 |
| **動能** | MACD | -0.350 | 🔴 | MACD 線位處零軸下方，柱狀圖 (-0.182) 空頭佔優 |
| **波動** | ATR(14) | $0.87 | 🟡 | 占價格 5.32%，每日波幅適中 |
| **通道** | 布林通道 | %B = 0.22 | 🟡 | 接近布林下軌 $15.50，短線超賣醞釀反彈 |

### 🏆 技術評分卡

```
╔══════════════════════════════════════════════════════════════╗
║                技術評分卡 — SOFI (2026-08-02)                ║
╠══════════════════════════════════════════════════════════════╣
║ 趨勢強度 (ADX) ███████░░░░░░░░░░░░░ 35/100 🔴 無明確主趨勢    ║
║ 動能指標 (MACD/RSI) ███████░░░░░░░░░░░░░ 38/100 🔴 空頭動能佔優║
║ 支撐穩定度 (S1/S2)  █████████████░░░░░░ 65/100 🟡 S1 $15.58 支撐  ║
║ 成交量配合 (OBV)    ████████░░░░░░░░░░░░ 40/100 🔴 量能未見放大  ║
║ 形態完整度 (區間)   ████████████░░░░░░░░ 60/100 🟡 $14.88-$18.75 ║
║ 均線結構 (MA)       █████░░░░░░░░░░░░░░░ 25/100 🔴 價格全處均線下  ║
╠══════════════════════════════════════════════════════════════╣
║ 綜合評分           ████████░░░░░░░░░░░░ 42/100 🟡 區間震盪築底║
╚══════════════════════════════════════════════════════════════╝
```
...
```mermaid
graph TD
    A["月線框架 (長期)"] -->|"高點 $29.72 回落至 52W 低點附近"| B["熊市修正 / 築底期"]
    C["週線框架 (中期)"] -->|"成交量維持 400M+，高檔賣壓消化中"| D["$15.23 - $19.43 寬幅箱體震盪"]
    E["日線框架 (短期)"] -->|"價格自 7/12 高點 $18.78 連續回落"| F["短線尋找 S1 $15.58 第一支撐"]
    
    B --> G["多時框收斂：當前 ADX=16.29 低於 25，市場進入區間盤整市場"]
    D --> G
    F --> G
```
...
| 階段 | 時間段 | 價格區間 | 變動幅度 | 主要驅動因素與技術特徵 |
|------|--------|----------|----------|------------------------|
| **主升段** | 2025/08 - 2025/11 | $25.54 → $29.72 | +16.37% | 強勢突破，放量攻頂，觸及 52週高點 $32.73 區域 |
| **修正段** | 2025/12 - 2026/03 | $26.18 → $15.88 | -39.34% | 獲利了結賣壓湧現，連續跌破 MA50 與 MA200 |
| **築底打底** | 2026/04 - 2026/07 | $16.10 → $16.31 | +1.30% | 於 $14.88 (52W 低點) 上方進行 $15.50 - $18.75 箱體震盪 |

### 📊 中期趨勢（週線分析）

近期 20 週收盤數據顯示，SOFI 於 2026年3月底下探波段低點 $15.23 後，出現顯著的反彈力道，於 2026年4月中旬攻至 $19.43，隨後在 2026年7月中旬再次觸及 $18.78 高點後拉回。
...
```mermaid
graph TD
    A["ADX (14) = 16.29"] -->|"ADX < 25"| B["無明確單向趨勢 / 盤整行情"]
    C["+DI = 21.69"] --> D["多空對峙分析"]
    E["-DI = 28.16"] --> D
    D -->|" -DI > +DI "| F["空頭小幅占優，但缺乏強烈動能推降"]
```

| ADX 數值區間 | 趨勢狀態 | SOFI 當前位置 | 交易策略導向 |
|--------------|----------|---------------|--------------|
| 0 - 20 | 無趨勢 / 極弱 | **16.29 (當前)** | **高拋低吸 / 區間操作 (布林通道上下軌)** |
| 20 - 25 | 趨勢形成中 | — | 準備順勢突破交易 |
| 25 - 50 | 強勢趨勢 | — | 採用均線跟蹤 / 順勢操作 |
| > 50 | 極端強烈趨勢 | — | 警惕趨勢過度拉升/回撤風險 |
...
```mermaid
graph TD
    A["圖表形態識別"] --> B["底部箱體整理 ($14.88 - $18.75)"]
    A --> C["下降通道 (2025/11 高點拉回)"]
    
    B --> B1["信心度: 80%"]
    C --> C1["信心度: 45% (已進入末端收斂)"]
```

**形態評估信心度與目標價算式表**（依據 strict rule 13 & 15）：

| 形態類型 | 信心度 | 判斷依據（引用數據） | 完成度 | 目標價計算式 | 計算結果 |
|----------|--------|----------------------|--------|--------------|----------|
| **箱體整理 (矩形)** | 80% | 頂部受制於 R1 $18.75，底部獲 S1 $15.58/52W 低點 $14.88 支撐 | 75% | 向上突破：頸線 $18.75 + 箱高 ($18.75 - $14.88 = $3.87) | **$22.62** |
| **下降通道** | 45% | 自 2025-11 高點 $29.72 下降，數據缺乏明確下軌聚類線 | 40% | 訊號不足，僅作參考 | N/ A |

*註：由於數據未顯示完整的雙底或頭肩底幾何形態，本報告嚴格依據數據，僅認定「矩形箱體整理」，不強行描繪未確認形態。*

### 🕯️ 重要 K 線形態分析

| 月份 | 收盤價 | K線形態類型 | 技術解讀 | 訊號 |
|------|--------|-------------|----------|------|
| 2026-03 | $15.88 | 長下影錘子線 | 下探 52週低點 $14.88 後強勢拉回，顯示底部買盤進駐 | 🟢 多頭抵抗 |
| 2026-05 | $18.22 | 大陽線實體 | 強勢反彈突破 MA20，帶動短線多頭動能 | 🟢 短線轉強 |
| 2026-07 | $16.31 | 中陰線回落 | 攻高 $18.78 遭阻，回測箱體中下軌尋求支撐 | 🔴 短線修正 |
...
以已確認的**箱體整理形態**進行突破推導：
1. **箱體高度** = 頂部阻力 ($18.75) - 底部支撐 ($14.88) = **$3.87**
2. **多頭突破目標** = 箱頂 ($18.75) + 箱高 ($3.87) = **$22.62**
3. **空頭跌破目標** = 箱底 ($14.88) - 箱高 ($3.87) = **$11.01**
...
|----------|----------|----------|----------|--------|
| **R1** | **$18.75** | 近一年波段高點聚類、箱體整理上界 | 🔴 高 | ★★★★★ |
| **R2** | **$19.74** | 波段高點解套賣壓區 | 🟡 中高 | ★★★★☆ |
| **R3** | **$20.13** | 整數關卡與前波密集成交區 | 🔴 高 | ★★★★☆ |

### 🛡️ 支撐位分析表

| 支撐級別 | 精確價位 | 形成原因 | 守住機率 | 重要性 |
|----------|----------|----------|----------|--------|
| **S1** | **$15.58** | 近一年波段低點聚類、密集買盤防線 | 🟢 高 (70%) | ★★★★★ |
| **S2** | **$14.93** | 歷史低點上方最後防線 | 🟢 極高 (85%) | ★★★★★ |

### 📐 斐波那契回調位分析

依據 52週區間（高點 **$32.73** → 低點 **$14.88**，波幅 **$17.85**）：

| 斐波那契層級 | 精確價位 | 與現價距離 | 技術含義 |
|--------------|----------|------------|----------|
| **0.0% (52W High)** | $32.73 | +100.67% | 歷史頂部 |
| **23.6%** | $28.52 | +74.86% | 多頭強勢反彈區 |
| **38.2%** | $25.91 | +58.86% | 中期多空分水嶺 |
| **50.0%** | $23.80 | +45.92% | 重要心理關卡 |
| **61.8%** | $21.70 | +33.05% | 黃金分割回調位 (臨近 MA200 $21.31) |
| **78.6%** | $18.70 | +14.65% | 關鍵阻力區 (與 R1 $18.75 重疊) |
| **100.0% (52W Low)** | $14.88 | -8.77% | 52週最低點支撐 |

**解讀**：當前價格 $16.31 處於 78.6% ($18.70) 與 100.0% ($14.88) 之間的低檔打底區間。若向上突破 78.6% ($18.70/R1)，將開啟向 61.8% ($21.70) 尋求估值修復的大級別行情。
...
```mermaid
graph TD
    MA["均線系統: 混合偏空 (現價<$17.36)"] --> SIGNAL["綜合技術指標診斷"]
    RSI["RSI(14): 37.36 (中性偏弱)"] --> SIGNAL
    MACD["MACD: -0.350 (柱狀圖 -0.182 看空)"] --> SIGNAL
    BB["布林通道: %B=0.22 (靠近下軌)"] --> SIGNAL
    ADX["ADX: 16.29 (盤整無趨勢)"] --> SIGNAL
    
    SIGNAL --> RESULT["短期承壓，但進入區間下軌超賣反彈準備期"]
```
...
```mermaid
graph TD
    PRICE["現價 $16.31"] -->|"下方 -0.12%"| MA5["MA5 $16.33"]
    PRICE -->|"下方 -2.03%"| MA10["MA10 $16.65"]
    PRICE -->|"下方 -6.03%"| MA20["MA20 $17.36 (布林中軌)"]
    PRICE -->|"下方 -3.84%"| MA60["MA60 $16.96"]
    PRICE -->|"下方 -23.46%"| MA200["MA200 $21.31"]
    
    MA5 --> ALIGN["短中長期均線呈現混合空頭排列，壓力重重"]
    MA200 --> ALIGN
```

| 均線天數 | 當前價位 | 價格關係 | 偏離率 | 走勢趨勢 |
|----------|----------|----------|--------|----------|
| **MA 5** | $16.33 | 位於下方 | -0.12% | 微幅向下 |
| **MA 10** | $16.65 | 位於下方 | -2.03% | 下降中 |
| **MA 20** | $17.36 | 位於下方 | -6.03% | 下降中 |
| **MA 60** | $16.96 | 位於下方 | -3.84% | 走平走低 |
| **MA 120**| $17.42 | 位於下方 | -6.36% | 下降中 |
| **MA 200**| $21.31 | 位於下方 | -23.46% | 下降中 |
...
- **超買/超賣判斷**：37.36 處於 30-70 中性區間，尚未跌破 30 進入極端超賣，但顯示賣盤力量強於買盤。
- **背離分析**：檢視近期走勢，價格自 $18.78 (7/12) 回落至 $16.31，RSI 同步由 58.4 降至 37.36，**無明顯頂背離或底背離**，屬正常的動能同步回撤。

### 📊 MACD(12,26,9) 訊號解讀

- **DIF (MACD線)**：-0.350
- **DEA (Signal線)**：-0.168
- **MACD Histogram (柱狀圖)**：-0.182 🔴

```mermaid
graph LR
    DIF["MACD線 (-0.350)"] -->|"位於零軸下方且低於 Signal"| DEAD["死叉狀態"]
    DEA["Signal線 (-0.168)"] --> DEAD
    DEAD --> HIST["柱狀圖 -0.182 (綠柱擴大/空頭增強)"]
```
**解讀**：MACD 在零軸下方維持死叉，柱狀圖持續負向擴大，表明短期下行動能尚未完全耗盡，需等待柱狀圖縮頭（Histogram 翻紅）作為左側止跌訊號。

### 📦 布林通道分析

```
SOFI 布林通道結構示意圖
$19.21 ───────── Upper Band (布林上軌)
       \
$17.36 ──*────── Middle Band (MA20 中軌)
          \
$16.31 ────*──── 當前價格 ($16.31, %B = 0.22)
            \
$15.50 ─────── Lower Band (布林下軌)
```

- **通道帶寬**：($19.21 - $15.50) / $17.36 = **21.37%** (帶寬收窄後維持穩定)
- **%B 位置**：**0.22** (靠近下軌 0.0 位置)，歷史數據顯示，當 %B 降至 0.15-0.20 區域時，股價往往具備技術性反彈契機。

### 💹 成交量分析（量價配合度）

- **最新成交量**：56,557,700 股
- **20日均量**：86,995,480 股（**量比 0.65x**）
- **OBV 趨勢**：OBV < MA，顯示資金呈淨流出狀態。
- **量價診斷**：股價回撤過程中成交量顯著萎縮（0.65x 均量），屬於「**無量下跌/縮量回撤**」，意味著市場拋壓主要來自缺乏買盤承接，而非恐慌性主力甩轎。
...
| 象限區劃 | 動能強度 | 波動率 | 當前 SOFI 狀態 | 操作含義 |
|----------|----------|--------|----------------|----------|
| **Q1 (右上)** | 強 | 高 | — | 追漲高風險高收益 |
| **Q2 (右下)** | 強 | 低 | — | 最佳順勢持股期 |
| **Q3 (左上)** | 弱 | 高 | — | 避免進場，恐慌殺跌 |
| **Q4 (左下)** | **弱** | **低/中** | **✓ (SOFI 當前)** | **縮量築底，醞釀區間反彈** |

```mermaid
graph TD
    A["SOFI 動能與波動診斷"] --> B["ADX = 16.29 (低動能)"]
    A --> C["ATR = $0.87 (中低波動)"]
    B --> D["綜合歸類：Q4 區間低動能打底"]
    C --> D
```
...
- **每日預期波動範圍**：$16.31 ± $0.87 ($15.44 - $17.18)
- **止損距離建議**：
  - 短線交易 (1.5x ATR)：$0.87 × 1.5 = **$1.31**
  - 中線交易 (2.0x ATR)：$0.87 × 2.0 = **$1.74**

### 📐 Beta 與市場相關性

- **Beta 係數**：**2.149**
- **市場意義**：SOFI 屬於高 Beta 成長型金融科技股，波動度為標普 500 指數的 2.15 倍。在大盤走強時具高彈性，但大盤調整時承壓更顯著。
...
| 時框架 | 趨勢方向 | 動能 (RSI/MACD) | 均線排列 | 形態 | 綜合評分 | 操作建議 |
|--------|----------|-----------------|----------|------|----------|----------|
| **日線 (Daily)** | 🔴 偏空 | 🔴 MACD死叉 (37.3) | 🔴 全下 | 箱體回落 | 35/100 | 觀望/尋求 S1 承接 |
| **週線 (Weekly)**| 🟡 盤整 | 🟡 柱狀圖-0.182 | 🟡 混合 | 寬幅箱體 | 48/100 | 區間下軌低吸 |
| **月線 (Monthly)**| 🟡 築底 | 🟡 接近歷史底部 | 🔴 空頭 | 大型打底 | 45/100 | 長線價值佈局 |
...
│  月 線   │   🟡     │   🟡     │   🟡     │
└──────────┴──────────┴──────────┴──────────┘
訊號收斂結果：中期與長期處於盤整打底，短期回撤觸及區間下軌。
```

### ⚖️ 多時框收斂結論

依據多時框收斂規則（ADX=16.29 < 25），**當前市場確立為「盤整行情」**。主導交易時框為日線布林通道（$15.50 - $19.21）與關鍵支撐阻力位（S1 $15.58 / R1 $18.75）。最終方向性結論：**🟡 中性觀望 / 區間下軌高盈虧比低吸**。
...
```mermaid
graph TD
    START["當前價格 $16.31 (ADX 16.29 盤整)"] --> CHOOSE{"價格接近 S1 $15.58 還是 R1 $18.75?"}
    CHOOSE -->|"靠近箱體下軌 $15.58"| STRAT_A["🟢 主策略：箱體下軌低吸 / 技術性反彈"]
    CHOOSE -->|"若跌破 S1/S2 $14.88"| STRAT_B["🔴 避險策略：停損觀望 / 空頭對沖"]
```

### 🧭 策略路由

**當前主策略方向 = 🟢 區間下軌逢低佈局（依評分 42/100，定位為盤整低吸）**

### 🎯 價格情境階梯 (Price Scenarios)

| 觸發條件 | 第一目標 | 第二目標 | 情境技術含義 |
|----------|----------|----------|--------------|
| **突破 R1 $18.75** | R2 $19.74 | R3 $20.13 / 61.8% $21.70 | 箱體向上突破，開啟大級別反彈行情 |
| **站穩現價區間** | BB中軌 $17.36 | R1 $18.75 | 箱體內部常規反彈震盪 |
| **跌破 S1 $15.58** | S2 $14.93 | 52W 低點 $14.88 | 再次尋求歷史底點支撐 |

### 📊 情境機率分佈

| 情境劇本 | 機率估計 | 主要技術依據 |
|----------|----------|--------------|
| **區間下軌反彈 (向上測試 $17.36-$18.75)** | **55%** | 價格逼近布林下軌 $15.50 與 S1 $15.58，縮量回撤顯示拋壓竭盡 |
| **維持 $15.50 - $17.00 狹幅震盪** | **30%** | ADX 16.29 低動能，成交量僅 0.65x 均量，市場觀望 |
| **跌破 $14.88 破底下探** | **15%** | 公司基本面與 PEG 0.78 具安全邊際，極端破底機率偏低 |

### 🟢 主策略詳情

根據嚴格數據紀律，所有價格均引用已計算之關鍵價位：

| 策略要素 | 策略 A：箱體低吸做多 (主策略) | 策略 B：突破跟進做多 (右側策略) |
|----------|----------------───────────────|----------------------------------|
| **進場條件** | 價格回撤至 $15.60 - $16.31 區間止跌 | 日線收盤價強勢突破 R1 $18.75 |
| **進場價格** | **$15.80** (掛單) 或 **$16.31** (現價) | **$18.80** (突破確認後) |
| **目標價 T1** | **$17.36** (MA20 / 布林中軌) | **$19.74** (阻力 R2) |
| **目標價 T2** | **$18.75** (阻力 R1 / 箱頂) | **$20.13** (阻力 R3) |
| **止損價格** | **$14.75** (跌破 52W 低點 $14.88 止損) | **$17.90** (假突破回落至 R1 下方) |
| **風險報酬比 (R:R)**| **2.81 : 1** (以 $15.80 進場計算) | **2.04 : 1** |
| **估算勝率** | **55%** | **50%** |
| **建議倉位** | **10% - 15%** | **10%** |

*R:R 計算公式示範 (策略 A以 $15.80 進場)*：
- 風險 (Risk) = $15.80 - $14.75 = $1.05
- 報酬 (Reward to T2) = $18.75 - $15.80 = $2.95
- **R:R** = $2.95 / $1.05 = **2.81**

### 🔴 反向風險觸發點（對沖提示）

- **觸發條件**：日線收盤價跌破 S2 **$14.93** 或 52週低點 **$14.88**。
- **對沖處置**：無條件執行多頭止損，不建議盲目攤平；極端下行目標由箱體推算為 **$11.01**。

### ⭐ 整體訊號強度評星

```
做多訊號強度：★★★☆☆  (3/5星 — 區間下軌高風報比)
做空訊號強度：★★☆☆☆  (2/5星 — 接近52W低點，做空盈虧比差)
整體可信度：  ★★★☆☆  (3/5星 — ADX盤整期，按箱體操作)
```
...
║                   每日交易監控 Checklist                     ║
╠══════════════════════════════════════════════════════════════╣
║ [ ] 價格是否守住 S1 $15.58 關鍵波段支撐位                   ║
║ [ ] 成交量是否放大至 87M (20日均量) 以上                     ║
║ [ ] MACD 柱狀圖 (-0.182) 是否開始縮頭 (走向 > -0.100)        ║
║ [ ] RSI(14) 能否重新站回 40-50 中性軸                        ║
║ [ ] 是否突破 MA20 ($17.36) 轉為短線多頭                      ║
╚══════════════════════════════════════════════════════════════╝
```
...
graph TD
    ...
    B --> B1["放量突破 R1 $18.75，挑戰 R2 $19.74 / R3 $20.13"]
    C --> C1["於 $15.58 - $18.75 區間進行 4-6 週打底震盪"]
    D --> D1["跌破 $14.88 52W 低點，觸發止損拋壓"]
```

### 🛡️ 風險管理重要提醒

1. **高 Beta 波動控制**：SOFI Beta 為 2.149，單日波幅大，單一交易倉位務必控制在總資金 15% 以內。
2. **嚴格執行價格止損**：以 52週低點下方 **$14.75** 為鐵血止損線，嚴禁隨意下移止損。
3. **量能確認原則**：若價格反彈至 R1 **$18.75** 但日成交量低於 80M 股，應全數獲利了結，避免假突破回撤。
...
```
╔══════════════════════════════════════════════════════════════╗
║               SOFI 技術分析總結 (2026-08-02)                  ║
╠══════════════════════════════════════════════════════════════╣
║ 當前價格：$16.31            52W區間：$14.88 - $32.73        ║
║ 綜合評級：🟡 中性偏空 (42/100)  市場形態：區間震盪打底 (ADX 16.29)║
╠══════════════════════════════════════════════════════════════╣
║ 關鍵支撐：S1 $15.58 / S2 $14.93 / 52W Low $14.88             ║
║ 關鍵阻力：MA20 $17.36 / R1 $18.75 / R2 $19.74 / R3 $20.13    ║
║ 分析師目標均價：$19.87 (距離當前 +21.8%)                       ║
╠══════════════════════════════════════════════════════════════╣
║ 最優交易策略組合：                                           ║
║ 1. 🥇 最佳機會：$15.80-$16.31 區間分批建立低吸多單 (策略 A)   ║
║    • 止損：$14.75  • 第一目標：$17.36  • 第二目標：$18.75      ║
║    • 風險報酬比：2.81 : 1                                    ║
║ 2. 🥈 右側機會：待放量突破 R1 $18.75 後順勢追多 (策略 B)     ║
║    • 止損：$17.90  • 目標：$19.74 / $20.13                     ║
╚══════════════════════════════════════════════════════════════╝
```

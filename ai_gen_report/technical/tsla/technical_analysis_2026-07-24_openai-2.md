...
| 形態 | 信心度 | 判斷依據 | 完成度 | 目標價 |
|------|--------|----------|--------|--------|
| 雙底 | 65% | 近期低點於 $297.82 | 80% | 頸線 $348.98 + 高度 $51.16 = $400.14 |

### 🕯️ 重要K線形態分析

| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 07月 | 313.03 | 長下影線 | 底部支撐強 | 🟢 |
...
- 頸線計算：支撐位 $297.82 至高點 $348.98，形態高度差 $51.16
- 預估目標價：$348.98 + $51.16 = $400.14
...
現價位於斐波那契 78.6% 回調區間（$340.84），支撐位於 100%（$297.82），顯示近期可能在此區間震盪。
...
- ATR：$16.78，建議止損距離約 $34（2 * ATR）

### 📐 Beta 與市場相關性

無 Beta 數據，無法判斷與市場相關性。
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 空頭 | 弱 | 空頭 | 潛在雙底 | 30 | 偏空觀望 |
| 中期 | 盤整 | 弱 | 空頭 | 無 | 40 | 觀望 |
| 長期 | 空頭 | 弱 | 空頭 | 無 | 30 | 偏空觀望 |
...
當前處於盤整行情（ADX < 25），以日線布林通道上下軌為主要交易區間，綜合判斷為偏空觀望。
...
- 嚴格止損：若價格跌破 $297.82，需嚴格執行止損
- 倉位控制：建議不超過資金的50%投入此策略

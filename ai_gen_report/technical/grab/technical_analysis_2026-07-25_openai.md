...
> **報告日期**：2026-07-25 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$3.31
...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $3.31 | 🟡 | 接近支撐位 S1 |
| **均線** | MA20 | $3.71 | 🔴 | 價格在 MA20 下方 |
| **均線** | MA50 | $3.57 | 🔴 | 價格在 MA50 下方 |
| **均線** | MA200 | $4.38 | 🔴 | 價格在 MA200 下方 |
| **動能** | RSI(14) | 25.89 | 🟢 | 超賣 |
| **動能** | MACD | -0.058 | 🔴 | 看空訊號 |
| **波動** | ATR | $0.15 | 🟡 | 中等波動 |
...
近期壓力與支撐示意圖顯示近期價格在 $3.18 至 $3.64 區間波動。
...
|------|--------|----------------------|--------|--------------------|
| 雙底 | 40% | 兩次低點於 $3.18 附近 | 70% | 訊號不足 |
| 下降三角形 | 75% | 近期高點下降，低點持平 | 90% | 頸線 $3.31 - 形態高度 $0.64 = $3.95 |

### 🕯️ 重要K線形態分析

| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-07 | $3.31 | 長下影線 | 可能反彈 | 🟡 |
...
現價 $3.31 位於 78.6% 回調位 $3.92 和 100% 低點 $3.18 之間，表明潛在反彈機會。
...
- ATR = $0.15，建議止損距離設置在 $0.30

### 📐 Beta 與市場相關性

- Beta = 0.875，對大盤波動敏感性中等，適合風險偏好較低投資者。
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 盤整 | 弱 | 看空 | 下降三角形 | 40 | 觀望 |
| 中期 | 看空 | 弱 | 看空 | 無 | 30 | 避免進場 |
| 長期 | 看空 | 弱 | 看空 | 無 | 25 | 謹慎觀望 |
...
| 站穩現價區間 | — | — | 區間震盪 |
| 跌破 S1 $3.18 | S2 $3.00 | S3 $2.80 | 中期轉弱 |

### 📊 情境機率分佈

| 情境 | 機率 | 主要依據 |
|------|------|----------|
| 繼續上行 / 反彈 | 20% | （引用 MACD、均線、OBV 等） |
| 區間震盪 | 40% | （引用 ADX、布林帶寬等） |
| 回落 / 再探底 | 40% | （引用 RSI、支撐強度等） |

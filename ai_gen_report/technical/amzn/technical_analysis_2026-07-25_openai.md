...
> **報告日期**：2026-07-25 ｜ **語言**：繁體中文 ｜ **數據來源**：Yahoo Finance ｜ **當前價格**：$232.11
...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $232.11 | 🔴 | 價格低於所有主要均線 |
| **均線** | MA20 | $243.84 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $249.22 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $234.59 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 37.26 | 🟡 | 中性偏低 |
| **動能** | MACD | -1.500 | 🔴 | 空頭信號 |
| **波動** | ATR | $6.80 | 🟡 | 中等波動 |
...
| 形態 | 信心度 | 判斷依據 | 完成度 | 目標價 |
|------|--------|----------|--------|--------|
| 雙頂 | 70% | 兩次高點於 $270 附近 | 80% | $220 |
| 三角形 | 50% | 形成中，需確認 | 50% | N/A |

### 🕯️ 重要K線形態分析

| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-04 | $265.06 | 長上影線 | 多頭反轉失敗 | 🔴 |
...
| S1 | $223 | 近期低點 | 中等 | 高 |
| S2 | $215 | 長期低點 | 高 | 非常高 |
| S3 | $211 | 歷史低點聚集 | 非常高 | 非常高 |

### 📐 斐波那契回調位分析

現價 $232.11 落在斐波那契 61.8% ($227.54) 和 78.6% ($213.67) 之間，這表示市場可能處於強支撐區域，但若跌破 $223，可能面臨進一步下跌風險。
...
近期成交量低於 20 日均量，顯示價格下跌時量能不足，可能預示短期反彈。
...
ATR 為 $6.80，屬於中等波動，建議止損距離設置在 ATR 的 1.5 倍即 $10.20。

### 📐 Beta 與市場相關性

AMZN 的 Beta 為 1.461，顯示其價格波動性大於大盤，適合風險承受度高的投資者。
...
|--------|----------|------|----------|------|----------|------|
| 長期 | 下降 | 弱 | 空頭 | 雙頂 | 35/100 | 観望 |
| 中期 | 盤整 | 中性 | 空頭 | 三角形 | 40/100 | 觀望 |
| 短期 | 下降 | 弱 | 空頭 | 無 | 30/100 | 空頭 |
...
當前市場為盤整行情（ADX < 25），以中期趨勢為主導，整體偏空，建議觀望或短期空頭操作。
...
| 情境 | 機率 | 主要依據 |
|------|------|----------|
| 繼續上行 / 反彈 | 30% | MACD 可能反彈，RSI 中性 |
| 區間震盪 | 50% | ADX 低，布林通道收窄 |
| 回落 / 再探底 | 20% | 價格低於所有均線，成交量不足 |

### 🟢 主策略詳情（方向依上方路由）

| 策略要素 | 策略 A | 策略 B |
|----------|--------|--------|
| 進場條件 | 確認價格跌破 S1 $223 | 確認價格跌破 S2 $215 |
| 進場價格 | $223 | $215 |
| 目標價 T1 | $215 | $211 |
| 目標價 T2 | $211 | $196 |
| 止損價格 | $237 | $223 |

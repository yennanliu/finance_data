...
現價 $319.09 位於斐波那契 38.2% 回調位 $321.69 附近，表明價格可能在此區域尋找支撐。
...
| 中期   | 下跌    | 弱  | 看空    | 無   | 35/100   | 偏空 |
| 長期   | 下跌    | 弱  | 看空    | 無   | 30/100   | 偏空 |

### 🔲 綜合訊號矩陣

綜合分析顯示短期內偏空，但強支撐可能提供支撐。

### ⚖️ 多時框收斂結論

當前為盤整行情（ADX<25），以中期週線為主，方向偏空。
...
**當前主策略方向 = 偏空（依評分 43/100）**

### 🎯 價格情境階梯（Price Scenarios）

| 觸發條件 | 下一目標 | 後續延伸 | 情境含義 |
|----------|----------|----------|----------|
| 突破 R1 $328 | R2 $340 | R3 $349 | 短線轉強 |
| 站穩現價區間 | — | — | 區間震盪 |
| 跌破 S1 $308 | S2 $296 | S3 $271 | 中期轉弱 |
...
最優策略組合：
1. 🥇 最佳機會：觀望，等待突破確認。
2. 🥈 次選機會：若跌破 $308，考慮進入空頭策略。
3. 🥉 保守選擇：若反彈至 $328，考慮減倉。
════════════════════════════════════════════════════════
```

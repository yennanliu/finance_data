...
|----------|----------|----------|------|------|
| **價格** | 當前價格 | $47.35 | 🔴 | 低於所有主要均線 |
| **均線** | MA20 | $49.13 | 🔴 | 價格在MA下方 |
| **均線** | MA50 | $53.44 | 🔴 | 價格在MA下方 |
| **均線** | MA200 | $76.47 | 🔴 | 價格在MA下方 |
| **動能** | RSI(14) | 35.06 | 🟡 | 中性，接近超賣 |
| **動能** | MACD | +0.250 | 🟢 | 多頭訊號 |
| **波動** | ATR | $2.86 | 🟡 | 中等波動 |
...
|--------|----------|----------|--------|------|
| 2025年下半年 | $58.70 | $103.01 | +75.51% | 強勁上升 |
| 2026年上半年 | $103.01 | $47.35 | -54.04% | 大幅下跌 |
...
| 月份 | 收盤價 | K線形態 | 解讀 | 訊號 |
|------|--------|---------|------|------|
| 2026-04 | $63.05 | 上影線 | 多頭乏力 | 🔴 |
| 2026-07 | $47.35 | 十字星 | 觀望 | 🟡 |
...
現價 $47.35 位於斐波那契 78.6% 回調位（$64.50）下方，顯示出現強勁回調壓力。
...
```mermaid
graph TD
    A["MACD Hist +0.250"] -->|"多頭訊號"| B["看多"]
    C["MACD線 -1.826"] -->|"空頭"| D["觀望"]
```
...
ATR 為 $2.86，建議止損距離設於 $3.00，以避免被日常波動掃出。

### 📐 Beta 與市場相關性

Beta 值 1.07，與市場相關性較高，受大盤波動影響顯著。
...
|--------|----------|------|----------|------|----------|------|
| 短期 | 盤整 | 中性 | 看空 | 無 | 40/100 | 觀望 |
| 中期 | 下跌 | 弱 | 看空 | 無 | 30/100 | 避免 |
| 長期 | 下跌 | 弱 | 看空 | 無 | 20/100 | 避免 |
...
依據 ADX 10.06，當前為盤整行情。主導時框為中期（週線），建議觀望，避免大幅進場操作。
...
**當前主策略方向 = 觀望（依評分 30/100）**

### 🎯 價格情境階梯（Price Scenarios）

| 觸發條件 | 下一目標 | 後續延伸 | 情境含義 |
|----------|----------|----------|----------|
| 突破 R1 $54.22 | R2 $58.88 | R3 $66.83 | 短線轉強 |
| 站穩現價區間 | — | — | 區間震盪 |
| 跌破 S1 $45.80 | — | — | 中期轉弱 |
